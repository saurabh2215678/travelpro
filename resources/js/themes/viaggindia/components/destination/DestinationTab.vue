            ...
            <div class="detail_tab_section">
                <div class="container">
                    <ul class="scrollspy_btns" ref="navRef">
                        <li class="uppercase" @click="handleActive('dest_about')"><a href="#dest_about" class="active">{{showLangTitle('About')}} {{destination?.name}}</a></li>
                        ...
                        <li v-if="destination.images" class="uppercase" @click="handleActive('dest_gallery')"><a href="#photo_gallery">{{showLangTitle('PhotoGallery')}}</a></li>
                    </ul>
                </div>
            </div>
            <div class="inner_content_block">
                <div class="container">
                    <div id="dest_about" class="tabcontent" scrollspy-section>
                        <!-- <div class="text-3xl font-semibold pt-5 pb-5">{{showLangTitle('About')}}</div> -->
