...
& .no_price .booknow_btn .btn_group {
    display: flex;
    align-items: center;
    column-gap: 1rem;
}
& .no_price .booknow_btn .btn_group .req_price {
    color: var(--theme-color);
    font-weight: 600;
}
& .no_price .booknow_btn {
    padding-bottom: 0;
    width: fit-content;
}
& ul.inclusions {
...
@media (max-width: 767px){
    ...
    & .flex_package {padding-top:1rem!important;}
    & .bg_share{
        padding:0;
        & .social_icon a{font-size: .8rem;}
    }
    & ul.inclusions{margin:1rem 0 0;justify-content: space-between;}
    & .overview_box {
        .package_disc {
            flex-wrap:wrap;
            .list_row_right{margin-top:1rem;}
        }
    }
}
