    ...
    <div class="container">
      <div class="packaging_wrap_inner">
        ...
        <div class="side_bar">
          <form id="adv_package_search" :action="store.websiteSettings?.PACKAGE_URL">
            ...
            <div class="filter_box">
              <div class="sidetitle text-base font-semibold mx-3">
                {{showLangTitle('PackageType')}}
              </div>
              <div class="checkbox_list px-3">
                ...
                <label for="filter_tour_type_group">{{showLangTitle('GroupTour')}}</label><br>
              </div>
              <div class="checkbox_list px-3">
                ...
                <label for="filter_tour_type_fixed">{{showLangTitle('FixedTour')}}</label><br>
              </div>
              <div class="checkbox_list px-3">
                ...
                <label for="filter_tour_type_open">{{showLangTitle('OpenTour')}}</label><br>
              </div>
            </div>
            <div class="filter_box">
              <div class="sidetitle text-base font-semibold mx-3">{{showLangTitle('Categories')}}</div>
            ...
            <div class="filter_box">
              <div class="sidetitle text-base font-semibold mx-3">{{showLangTitle('LocationWise')}}</div>
            ...
            <div class="filter_box">
              <div class="sidetitle text-base font-semibold mx-3">{{showLangTitle('BudgetPerPerson')}} (nella €)</div>
            ...
            <div class="filter_box">
              <div class="sidetitle text-base font-semibold mx-3">{{showLangTitle('MonthWise')}}</div>
            ...
            <ul class="filter_button">
              ...
              <li><Link :href="store.websiteSettings?.PACKAGE_URL" class="btn2" @click="this.filterOpened = false">{{showLangTitle('Clear')}}</Link></li>
            </ul>
        ...
        <div class="packaging_view">
          ...
          {{ collapsed ? showLangTitle('HideInfo') : showLangTitle('MoreInfo') }}
          ...
          <template v-else>
            ...
            <template v-else>
              <div class="alert_not_found">Nessun pacchetto trovato(i) corrispondente ai tuoi criteri di ricerca. Cerca un pacchetto alternativo o chiama i nostri esperti di viaggio al numero <a :href="`tel:${store.websiteSettings?.BOOKING_QUERIES_NO}`">{{store.websiteSettings?.BOOKING_QUERIES_NO}}.</a> Puoi anche inviarci un'e-mail a <a :href="`mailto:${store.websiteSettings?.SALES_EMAIL}`">{{store.websiteSettings?.SALES_EMAIL}}</a></div>
            </template>
          </template>
        </div>
      </div>
...
import {showLangTitle} from '../utils/commonFuntions.js';
...
export default {
  ...
  layout: Layout,
  props: ["search_data", "seo_data", "themes", "destinations", "budgetList"],
};
</script>