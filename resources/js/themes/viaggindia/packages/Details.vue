<template>
<div style="background:var(--theme-color);width:100%;height:6.875rem;"></div>
    ...
    <SinglePackageWrapper class="single_package_details py-0 mb-5">
        <div class="w-full overflow-hidden">
                            ...
                            <div class="inclusions_share flex flex-wrap">
                                ...
                                <div class="share-section w-6/12">
                                    <div class="flex py-0 pt-3 pl-1.5 items-center">
                                        <div class="bg_share">
                                            <p class="mr-3">{{showLangTitle('ShareItOn')}}:</p>
            ...
            <div class="row">
                <div class="container">
                    <div class="flex flex-wrap pt-16 flex_package right_side">
                        <div class="w-4/6 pr-9 mo_full">
                            ...
                            <div class="py-3.5 px-5 border border-gray-300 rounded">
                            ...
                            <!--- ======== Description  ======== -->
                            <div class="package_disc overview_box mt-5 mb-5 py-3.5 px-5 border border-gray-300 rounded" v-if="package.brief">
                                <div class="package_disc flex items-center mt-5 mb-5">
                                <h2 class="text-base font-semibold mr-3">{{showLangTitle('Activities')}}</h2>
                                ...
                                <div class="text-2xl font-semibold pb-3">{{showLangTitle('Overview')}}</div>
                                <p v-html="package.brief"></p>
                                <p v-html="package.description" v-if="this.readMore"></p>
                                <template v-if="package.description"><span id="s_more" @click="handleReadMore">{{(this.readMore)?showLangTitle('ReadLess'):showLangTitle('ReadMore')}}</span></template>
                            </div>
                            <!--- ======== Flight  ======== -->
                            ...
                            <div class="listSec">
                            <ul>
                                <li class="active"><a href="#packageIt">{{showLangTitle('Itinerary')}}</a></li>
                                <li v-if="store.accommodations_days && store.accommodations_days.length > 0"><a href="#package_accommodations">{{showLangTitle('Accommodation')}}</a></li>
                                <li v-if="this.testimonials && this.testimonials.length > 0"><a href="#review">{{showLangTitle('Review')}}</a></li>
                            </ul>
                            </div>
                            <div id="packageIt" class="package_day secpad py-3.5 px-5 border border-gray-300 rounded" v-if="this.package_itenaries && this.package_itenaries.length > 0 && package.is_activity == 0">
                                <div class="container-full">
                                    <h3 class="text-xl font-semibold pb-2">{{showLangTitle('PackageItinerary')}}</h3>
                                                ...
                                                <div class="ml-16">
                                                    ...
                                                    <div class="faq_data">
                                                        <div class="faq_service package_disc overview_box pb-3 mb-3" v-if="itenary.itenary_inclusions_arr">
                                                            <div class="title2 mb-1 text-base font-semibold" v-if="itenary?.itenary_inclusions_arr?.length > 0">{{showLangTitle('ServicesIncluded')}}</div>
                            ...
                            <!--- ======== Accommodation  Old ======== -->
                            <div class="accommodation accordion mt-5 mb-5 pt-5 py-3.5 px-5 border border-gray-300 rounded" v-if="this.packagePolicy()">
                                <div class="container1">
                                    <h3 class="text-xl font-semibold mb-3">{{showLangTitle('Policy')}}</h3>
                                    <div class="faqlist">
                                        <ul>
                                            <li class="faq_main" v-if="package.inclusions">
                                                <div class="faq_title heading6">{{showLangTitle('Inclusions')}}</div>
                                                <div class="faq_data">
                                                    <span v-html="package.inclusions"></span>
                                                </div>
                                            </li>
                                            <li class="faq_main" v-if="package.exclusions">
                                                <div class="faq_title heading6">{{showLangTitle('Exclusions')}}</div>
                                                <div class="faq_data">
                                            ...
                                            <li class="faq_main" v-if="package.payment_policy">
                                                <div>
                                                    <div class="faq_title heading6">{{showLangTitle('PaymentPolicy')}}</div>
                                            ...
                                            <li class="faq_main" v-if="package.cancellation_policy">
                                                <div>
                                                    <div class="faq_title heading6">{{showLangTitle('CancellationPolicy')}}</div>
                                                    <div class="faq_data" style="">
                                            ...
                                            <li class="faq_main" v-if="package.terms_conditions">
                                                <div>
                                                    <div class="faq_title heading6">{{showLangTitle('TermsAndConditions')}}</div>
                                                    <div class="faq_data" style="">
                                        ...
                                        <template v-if="faq_row && faq_row.length > 0">
                                            ...
                                            <div class="theme_title mb-3">
                                                <h3 class="text-xl font-bold">{{showLangTitle('FAQsAbout')}} {{package.title}}</h3>
                                            </div>
                                            <ul>
                                        ...
                                        <div class="bg_share">
                                            ...
                                            <div class="footer_bottom_right">
                                                <ul class="social_icon">
                                                    <li class="facebook" v-if="sharing_links.facebook"><a
                                                        :href="sharing_links.facebook"
                                                        target="_blank"><i class="fa-brands fa-facebook-f"></i> {{showLangTitle('Share')}}</a>
                                                    </li>
                                                    <li class="twitter" v-if="sharing_links.twitter"><a
                                                        :href="sharing_links.twitter"
                                                        target="_blank"><i class="fa-brands fa-twitter"></i> {{showLangTitle('Tweet')}}</a>
                                                    </li>
                                                    <li class="whatsapp" v-if="sharing_links.whatsapp"><a
                                                        :href="sharing_links.whatsapp"
                                                        target="_blank"><i class="fa-brands fa-whatsapp"></i> {{showLangTitle('Whatsapp')}}</a>
                                                    </li>
                                                    <li class="instagram" v-if="sharing_links.instagram"><a
                                                        :href="sharing_links.instagram"
                        ...
                        <div class="w-4/12 mt-5 mo_full" v-if="this.package && this.package.id">
                            <div class="form_box-new single_package_form" id="packageEnquire_form">
                                <div class="form_box_inner">
                                    <h3 class="text-xl font-semibold pb-2">{{showLangTitle('YourPreference')}}</h3>
    ...
    <SinglePackageWrapper>
        ...
        :withPrice="true"
        :title="showLangTitle('SimilarPackages')"
        />
    </SinglePackageWrapper>
    ...
    <DestinationWrapper>
        ...
        :title="showLangTitle('MoreTripsDeparture')"
...
import {showPopup, hidePopup, showLangTitle} from '../utils/commonFuntions';
...
&:before{
    ...
    content: "";
    z-index: 2;
    background-image: linear-gradient(to top,#fff0 0%,rgb(0 0 0 / 63%) 100%);
}
& .right_price_box {
    width: 48%;
}
