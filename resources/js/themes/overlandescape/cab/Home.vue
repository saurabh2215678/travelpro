<template>        
    <div class="flight_page" v-if="store.websiteSettings">
        ...
        <template v-else-if="originSightSeenRouteData && originSightSeenRouteData.length > 0">
            <section class="home_featured pb-7 latoFont" v-for="sightseeningDestination in originSightSeenRouteData">
                <div class="xl:container xl:mx-auto">
                    <div class="text_left p_relative">
                        <div class="theme_title mb-3">
                            <div class="title text-2xl">Cab from {{sightseeningDestination.origin_name}}</div>
...
export default {
    ...
    layout: Layout,
    props: ["search_data", "seo_data", "destinationLists", "airportLists", "sightseeningDestinationLists","originSightSeenRouteData", "routeList"],
};
</script>