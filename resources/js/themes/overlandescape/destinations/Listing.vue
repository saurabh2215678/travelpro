<template>
    ...
    <DestinationCategoryList class="recommendation_places destination-cat pb_10">
        <div class="xl:container xl:mx-auto">
            <div class="theme-title">
                <h1 class="title text-2xl mb-5" v-if="store.seoData?.page_title">{{store.seoData?.page_title}}</h1>
                <div id="disc-title" class="text-left pb-3" v-if="store.seoData?.page_brief || store.seoData?.page_description">
...
const DestinationCategoryList = styled.section`
