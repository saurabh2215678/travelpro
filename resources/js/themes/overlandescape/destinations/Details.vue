<template>
    <SearchForm />
    <DestinationSection class="destination-slider">
        <div class="xl:container xl:mx-auto relative">
            <h1 class="font30 fw600" style="text-align:center;">Places to Visit in {{destination?.name}}</h1>
            <div class="text_center"> 
                <div class="theme_title mb-6">
                     <h2 class="title text-2xl font22 fw600">Top {{destination?.name}} Tours</h2>
    ...
    <DestinationSection class="destination-slider" v-if="popular_activities && popular_activities.length > 0">
        <div class="xl:container xl:mx-auto relative">
...
export default { 
    ...
    layout: Layout,
    props: ["destination", "search_data", "seo_data", "popular_packages", "tourPackagesUrl", "popular_activities", "tourActivitiesUrl", "faqs", "testimonials", "testimonialsUrl"],
};
</script>