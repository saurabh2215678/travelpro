    <template>
      ...
      <SingleActivityList class="packaging_wrap p_list_view">
        <div class="xl:container xl:mx-auto">
          <div class="packaging_wrap_inner">
            ...
            <ul class="filter_button">
              ...
              <li><Link :href="store.websiteSettings?.ACTIVITY_URL" class="btn2 ml-2">Clear</Link></li>
            </ul>
            ...
            <div class="packaging_view">
              ...
              <div id="disc-title" class="text-left" :class="collapsed ? 'collapsed' : ''" v-if="store.seoData?.page_brief || store.seoData?.page_description">
                <div class="description_inner">
                  <p v-if="store.seoData?.page_brief" class="text-brief" v-html="store.seoData.page_brief"></p>
                <p v-if="store.seoData?.page_description" class="text-desc" v-html="store.seoData.page_description"></p>
                </div>
              ...
              <template v-else>
                <template v-if="this.packageList.data && this.packageList.data.length > 0">
                  ...
                  <div class="packaging_top">
                    <div class="title font-bold">Showing {{this.total_count}} Activities For You</div>
                      <div class="sort_by">
      ...
      <ThemeFaq v-if="faqs && faqs.length > 0" :faqs="faqs" :seoData="seo_data" />
    </template>
<script>
...
const SingleActivityList = styled.section`
