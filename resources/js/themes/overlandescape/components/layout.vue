...
export default {
    ...
    updated() {
        ...
        if (meta_description != "" && meta_description != undefined && document.head.querySelector('meta[name="description"]')) {
            document.head.querySelector('meta[name="description"]').content =
                store.seoData?.meta_description;
        }
        if (meta_keyword != "" && meta_keyword != undefined && document.head.querySelector('meta[name="keywords"]')) {
