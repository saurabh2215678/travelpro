  <template>
      ...
      <div :class="`packaging_info ${(packageData?.packagePrices?.length > 0)?'':'no_price'}`" >
        ...
        <div class="price">
          ...
          <div class="right_side flex flex-wrap my-3">
            ...
            <Link :href="`${packageData.enquiry_url}&type=${this.typename}`" class="btn theme_clr enquir_now text-sm rounded-full">Enquire Now</Link>
    ...
    <PackageInclusionsList class="packaging_view_footer" v-if="packageData.package_inclusions && packageData.package_inclusions.length > 0">
  ...
  const PackageInclusionsList = styled.div`
