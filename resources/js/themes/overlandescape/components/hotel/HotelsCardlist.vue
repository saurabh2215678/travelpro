        ...
        <li>
            <div class="flex flex-row items-center">
                <div class="img-list-view w-1/3 m-2" ref="imgList">
                    ...
                    <div thumbsSlider="" class="swiper hotelViewgallery" style="margin-left:0;" v-if="accommodation.accommodationImages && accommodation.accommodationImages.length > 1">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" v-for="accommodationImage in accommodation.accommodationImages">
                                <img
                                :src="accommodationImage.thumbSrc"
                ...
                <div class="hotel-content-list-view w-1/2 p-3">
                    <div class="title text-xl">
                        <Link class="view-more text-sm mt-1 p-2" :href="accommodation.url" >{{accommodation.name}}</Link></div>
                        <div class="star-loc">
        ...
        methods:{
            ...
            setSliders(){
                if (!this.$refs.imgList) {
                    console.error('imgList ref is not defined.');
                    return;
                }
