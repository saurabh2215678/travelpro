                ...
                <div class="pricebook">
                    <div class="flex flex-row justify-between items-center">
                        <div class="pricebold price-list-view">
                            <em>
                                <div v-if="bike.publish_price && bike.search_price && parseFloat(bike.publish_price) > parseFloat(bike.search_price)" class="cut-price text-lg leading-normal pr-2"><span class="text-slate-500 relative">{{showPrice(bike.publish_price,true)}}</span></div>
                                {{showPrice(bike.search_price,true)}}
                            </em>
