...
export const HeaderWrapper = styled.header`
    ...
    & .header-middle .package_form h3{display:none;}
...
/* ********************** */
.header-middle .selectoption:nth-child(2), .header-middle .selectoption:nth-child(3) {
    display: none;
}
.header-middle .selectoption:nth-child(1){
    width:100%;
}
...
.header-middle .searchbtn:before {
    content: "\f002";
    position: absolute;
    z-index: 1;
    top: 50%;
...
.header-middle #search_packages {
    border-radius: 5rem;
    padding-left: 3.4rem;
    background-color: #b3b3ca29;
    
}

.header-middle .option_box {
    border-radius: 5rem;
    border: none;
}

.header-middle .option_box_wrapper {
