                    ...
                    <div class="signup_form">
                        <div class="singup_form_inner">
                            ...
                            <div class="form_group w-1/2">
                                <label for="company_name" class="text-sm">Company Registered Name</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="company_brand" class="text-sm">Company Brand/Trade Name</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="pan_no" class="text-sm">PAN Number</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="pan_image" class="text-sm">Upload PAN Card</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="company_owner_name" class="text-sm">Company Owner Name</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="no_of_employees" class="text-sm">Number of Employees?</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="agency_age" class="text-sm">How old is you agency?</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="destinations_sell_most" class="text-sm">Destinations you sell the most</label>
                            ...
                            <div class="form_group w-1/2">
                                <label for="region" class="text-sm">Your current travelers are from which region? (for international user)</label>
                            ...
                            <div class="form_group w-full">
                                <label for="company_profile" class="text-sm">Company Profile (Specialization, year of registration, company address, annual revenue)</label>
