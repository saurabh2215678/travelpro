<template>
    <div class="right_price_box">
        <form id="bookNowForm">
            <div class="par_cost pb-2 text-sm">From <span>{{showPrice(this.startingPrice,true)}}</span> per person</div>
            ...
            <div class="note_text text-sm mb-3 pt-2"><strong>Note* : </strong> More than 10
