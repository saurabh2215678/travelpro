<template>
    <HomePageBannerSliderWrapper>
                    ...
                    <div class="banner_content">
                        <div class="container">
                            <div class="slider-caption">
                                <div class="slider_heading font42 color_dark900 fw700 tracking-wide" v-html="image?.title"></div>
                                <div class="slider_para font15 color_dark mb-7" v-html="image?.sub_title"></div>
                                <a :href="image?.link_1" class="btn btn_theme btn_lg">Explore more</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="mobile_image hidden"><a href="/search-packages"><img class="banner_img" src="../../assets/images/mobile-banner.jpg" alt=""></a></div>
    </HomePageBannerSliderWrapper>
</template>
<script>
