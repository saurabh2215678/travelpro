    ...
    <template v-else>
        ...
        <div class="sm_price">
            ...
            <ul class="w-full">
                ...
                <template v-if="booking_data.gst_amount">
                    <li class="book_info_list"><span class="flex">GST Tax <em>:</em></span><span class=""> {{showPrice(booking_data.gst_amount,true)}}</span></li>
                </template>

                <template v-if="booking_data.tcs_amount">
                    <li class="book_info_list"><span class="flex">TCS Tax <em>:</em></span><span class=""> {{showPrice(booking_data.tcs_amount,true)}}</span></li>
                </template>
                ...
                <li class="book_info_list">
                    <span>Total Amount<em>:</em></span>
                    <span class="bold">{{showPrice(booking_data.total_amount,true)}}</span>
                </li>
            </ul>
        </div>        
    </template>
