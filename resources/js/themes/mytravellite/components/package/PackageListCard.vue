        ...
        <div class="packaging_view_footer_inner">
          ...
          <div class="right_side">
            <div class="flex flex-wrap my-3">
                <Link :href="this.bookingUrl" class="btn mr-3 text-sm bg_theme mb-2" v-if="this.publish_price && this.search_price && packageData.packagePrices.length > 0">Book Now</Link>
