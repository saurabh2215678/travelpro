<template>
    <SliderWrapper class="hotel_package_detail" >
        <div class="slider_box">
            <div class="swiper hotel_inner_slider" ref="sliderRef">
                            ...
                            <div class="hotel_info hotel_info_typeid385 " style="">
                                <div class="hotel_info_box itenery_info">
                                    ...
                                    <div class="star-loc">
                                        ...
                                        <div class="hotel_destination text-sm"><img alt="Map Icon" class="map-i" src="../../assets/images/map1.png">{{accommodation.place_name}} 
                                        </div>
                                    </div>
