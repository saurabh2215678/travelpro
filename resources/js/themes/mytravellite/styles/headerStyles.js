...
export const HeaderWrapper = styled.header`
    ...
    padding: 0 4rem;
    & .header_inner {display: flex; align-items: center;    padding: 1rem 0 0;}
    & .header_right { display: flex; align-items: center; min-width: 20rem; justify-content: flex-end; align-self: flex-start; padding-top: 0.5rem;}
