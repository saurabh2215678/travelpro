                                ...
                                <Link class="testi_item" :href="item.url">
                                    ...
                                    <div class="testimonial_item_bottom">
                                        ...
                                        <div class="profile_right">
                                            <h4 class="font23 fw600">{{ item.name }}</h4>
                                        </div>
                                    </div>
                                    <p class="font18" v-html="item.description"></p>
                                    <div class="font18 fw600 btn_theme" href="/"><span><img :src="'../assets/ladakhbikerental/images/arrow.png'" alt=""></span> Read More</div>
                                </Link>
