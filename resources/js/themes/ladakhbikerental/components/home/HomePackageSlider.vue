        ...
        <div class="container">
            <div class="title_wrapper">
                <div class="title_left" v-if="this.flagData && (this.flagData?.title || this.flagData?.brief) ">
                    <h3 :class="headingTitleClass ? headingTitleClass : 'font26 fw700 '">{{ this.flagData?.title }}</h3>
                    ...
                    <div class="swiper" ref="sliderRef">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" v-for="item in this.packages.data">
                                <PackageSliderCard :data="item" :hiderating="hiderating" :hidepricebox="true"/>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <Link :class="titleBtnClass ? titleBtnClass : 'font18 fw600 btn_theme'" :href="this.viewAllUrl" v-if="this.viewAllUrl"><span><img :src="'../assets/ladakhbikerental/images/arrow.png'" alt=""></span> {{this.viewAllTitle}}</Link>
            </div>
        </div>
