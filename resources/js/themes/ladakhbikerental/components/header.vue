        ...
        <div class="header_inner">
          ...
          <div class="header_middle">
            ...
            <div class="header_bottom flex">
              ...
              <div v-if="store.websiteSettings?.GOOGLE_TRANSLATOR_MANAGEMENT == 1">
                <div id="google_translate_element"></div>
              </div>
              <div class="search_formbtn">
                <div class="searchbtn cursor-pointer" @click="handleSearchActive"><i class="fa-solid fa-magnifying-glass"></i></div>
            ...
            <div class="header_menus">
              ...
              <!-- <div v-if="store?.websiteSettings?.SALES_PHONE" class="top_phone">
                <a :href="'tel:'+store?.websiteSettings?.SALES_PHONE">
                  <div class="svg_box">
                    <SvgRenderer svgPath="../assets/svgs/call.svg"/>
                  </div>
          ...
          <div class="search_box" :class="{ 'active': searchActive }">
            <PackageSearchForm v-if="searchActive" :closeSearch="closeSearch" />
          </div>
...
export default {
  ...
  mounted(){
    ...
    //         clickedElement.attr('data-slug').length > 0)){

    //     currentObj.searchActive = false;
    //   }
    // });
