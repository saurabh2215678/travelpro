       ...
       <div class="flex">
        <div class="option_box_wrapper">
          <div class="option_box">
            <div class="selectoption md:w-1/2 max-md:w-full search-first">
              <SvgRenderer svgPath="../assets/svgs/location.svg"/>
              <input type="text" name="text" class="form-control" :value="store.searchData?.text" id="search_packages" autocomplete="off" placeholder="Search Place/Package" v-on:keyup="searchPackages($event)" @click="loadPackages('')">
              <div class="search_packages">
                  <ul id="search_activities_ul">
                  </ul>
              </div>
            </div>
            <div class="selectoption md:w-1/3 max-md:w-full search-mdl">
              <SvgRenderer svgPath="../assets/svgs/number-of-days.svg"/>
            ...
            <div class="selectoption md:w-1/3 max-md:w-full search-last">
              <SvgRenderer svgPath="../assets/svgs/calendar.svg"/>
              <select name="smonth">
          ...
          <div class="searchbtn">
             ...
             <input type="submit" class="btn btn-primary search_input" value="Search">
...
export default {
  ...
  $(document).click(function(e){
    ...
    const SearchClicked = clickedElement.closest('.search-first');
    if(!(SearchClicked.length > 0)){
      $('#search_activities_ul').hide();
    }
  });
</script>