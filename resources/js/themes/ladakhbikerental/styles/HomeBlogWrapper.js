...
& .blog_box {
    ...
    :before{content:'';position:absolute;left:0;top:0;background-color: #0000007d;width: 100%;height: 100%;z-index: 0;}
...
& .blog_box:hover:after{width: 100%;background-color: rgba(255, 255, 255, 0);transition: all 0.6s ease-in-out;}
& .view_all_btn {
    text-align: center;
    margin-top: 3.5rem;
    & a {
