...
import PackageImageSlider from '../components/package/PackageImageSlider.vue';
...
export default {
    ...
    layout: Layout,
    props: ["package","packageSelectedPrice","faq_row","destinations","itenaries","sharing_links","search_data","seo_data","testimonials","similarPackages"],
};
</script>
