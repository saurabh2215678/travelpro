          ...
          <div class="package_info_wrap">
            <div class="package_top">
              ...
              <div class="flex flex-wrap flex-start">
                ...
                <div class="location mb-3 text-sm" v-if="packageData.packageDestination_name"><i class="fa-solid fa-location-dot"></i> {{packageData.packageDestination_name}}</div>
              </div>
            ...
            <div class="price">
              <div class="price_inner mb-2">
                ...
                <span class="amount heading_sm3">{{showPrice(this.booking_price,true)}}</span>
