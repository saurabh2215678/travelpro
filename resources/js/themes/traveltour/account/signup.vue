                    ...
                    <div class="signup_form">
                        <div class="singup_form_inner">
                            ...
                            <div class="form_group w-1/2 phone_group">
                                ...
                                <select class="form_control" name="country_code" @change="handleChange($event)">
                                    <option 
                            ...
                            <div class="create_account termsuse text-sm">
                                ...
                                <label for="termsuse" class="font-semibold text-xs"> By signing up, you agree to the Terms of Service and <Link :href="store.websiteSettings?.PRIVACY_LINK">Privacy Policy,</Link> including Cookie Use.</label>
