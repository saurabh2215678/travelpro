<template>
    <form method="POST" action="" id="form_home_page_form" class="common_main_form needs-validation left_form" novalidate  accept-charset="UTF-8" role="form" enctype="multipart/form-data">
        <div class="ajax_msg"></div>
        <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response"><input type="hidden" name="action" value="validate_captcha">
        <div class="formMessage"></div>
        <input type="hidden" name="_token" value="2bEYgp9oEuCcftWiff0bOCMELNAcPqeC9Z2uNSQ5">
        <div class="form-floating mb-3 w-1/2 w_mob"><label for="Name">Name</label><input type="text" placeholder="Name*" required class="form-control " dataTypeInput="inputname" name="input53" value="" /><span class="input53_error error"></span></div>
        <div class="form-floating mb-3 w-1/2 phone_code">
        ...
        <div class="form-floating mb-3 w-1/2">
            ...
            <select class="form-select "  name="input56">
        ...
        <div class="form-floating mb-3 w-1/4">
            <label for="Duration">Duration</label>
            <select class="form-select "  name="input57">
        ...
        <div class="form-floating mb-3 w-1/4">
            ...
            <select class="form-select "  name="input58">
        ...
        <div class="form-floating mb-3 w-1/4">
            <label for="No of Pax">No of Pax</label>
            <select class="form-select "  name="input59">
        ...
        <div class="form-floating mb-3 w-1/4">
            ...
            <select class="form-select "  name="input60">
        ...
        <div class="form-floating mb-3 w-full">
            <label for="Departure Fixed">Departure Fixed</label>
            <select class="form-select " required name="input62">
        ...
        <input type="hidden" name="form_slug" value="home_page_form"><input type="hidden" name="refer_url" value="https://overlandescape.tekzini.com">
