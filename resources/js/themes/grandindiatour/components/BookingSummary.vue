<template>
    <template v-if="action=='hotel_booking'">
        <div class="col_details">
            ...
            <div class="img-pack pt-1 pb-3 inline-block w-full">
                ...
                <div class="text-lg w-full">{{accommodation.name}}<br>
                    <p class="date-bg text-xs inline-block" style="color:#01b3a7;" v-if="inventory_data.room_id">{{inventory_data.AccommodationRoom?.room_type_name}}</p>
                    <br>
                    <p class="type-bg text-xs bg-orange-700 p-1 inline-block" v-if="inventory_data.plan_id">{{inventory_data.AccommodationPlan?.plan_name}}</p>
    ...
    <template v-else>
        ...
        <div class="img-pack pt-1 pb-3 inline-block w-full">
            ...
            <div class="text-lg leading-tight w-full">
                {{package.title}}<br>
