        ...
        <form @submit="handleFormSubmit" ref="formRef" id="pay_now_form" class="needs-validation" novalidate>
            ...
            <div class="form-group row">
                <div class="md:w-1/2">
                    ...
                    <div class="phone_wrap">
                        <select name="country_code" class="form-select form_control country_code">
                            <option 
            ...
            <div class="form-group row">
                <div class="md:w-1/2">
                    ...
                    <select name="country" class="form_control bg_blue">
                        <option 
                        v-for="country in countries" 
                        :value="country.name"
                        :selected="country.phonecode == '91'"
    ...
    name:'PayOnlineForm',
     created() {
      ...
      store.seoData = this.seo_data;
       //console.log('page store', this.countries);
    },
    beforeUnmount() {
