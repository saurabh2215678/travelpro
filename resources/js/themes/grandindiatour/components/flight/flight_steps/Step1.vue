<template>
    ...
    <div class="stp_wrap" :class="step2Shown ? 'step_2_showen' : ''" id="step_1" v-else>
        ...
        <div class="rts_flight" >
            ...
            <div class="fts_bottom">
                ...
                <div></div>
                <a class="stp_btn cursor-pointer" @click="stepShow">Add Passenger</a>
            </div>
        </div>
    </div>

    <template v-if="step2Shown">
        <Step2 :info="info" :price_id="price_id" />
    </template>
</template>
<script>
...
<style>
.detailed_riles_inner tr.det_row .det_wrap .det_content_wrap .tooltip_details * {color: #333 !important;}
</style>