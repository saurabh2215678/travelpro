...
& .det_btns button.active{background-color: var(--theme-color);}
& .det_btns button {background: var(--theme-color600);}
&.det_row .det_content .popper .tooltip_details * {color: #333 !important;}
