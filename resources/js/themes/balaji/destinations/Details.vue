<template>
    <section class="p-0">
        <div class="home_banner" v-for="image in store?.seoData?.banners">
            <img v-if="image" :src="image.src" class="w-100" :alt="destination?.name">
        </div>
    </section>
        ...
        <div class="xl:container xl:mx-auto relative">
            <div class="text_center"> 
                <div class="theme_title mb-6">
                    <h1 class="title text-2xl">{{destination?.name}}</h1>
                    <div class="breadcrumb_full">
                        <div class="container">
                            <ul class="breadcrumb">
                                <li><Link :href="store.websiteSettings?.FRONTEND_URL">Home</Link></li>
                                <li><Link :href="store.websiteSettings?.DESTINATION_URL">Destinations</Link></li>
            ...
            <div class="no_data text_center" v-else>
    ...
    <section class="destination-slider" v-if="popular_activities && popular_activities.length > 0">
        <div class="xl:container xl:mx-auto relative">
...
export default {
    created() {
        ...
        //console.log("Abhishek",store.seoData.banners);
    },
    data() {
        return {
            test: "test",
    ...
    layout: Layout,
    props: ["seo_data", "banner_image", "destination", "search_data", "popular_packages", "tourPackagesUrl", "popular_activities", "tourActivitiesUrl", "faqs", "testimonials", "testimonialsUrl"],
};
</script>