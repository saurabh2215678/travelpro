<template>
    <section class="home_hotel bggray home_featured" v-if="this.hotelList?.data && this.hotelList.data?.length > 0">
            ...
            <div class="p_relative">
                <div class="swiper hotel_slider">
                    <ul class="hotel_list swiper-wrapper">
                        <li class="swiper-slide" v-for="hotel in hotelList.data">
                                ...
                                <div class="hotel_content py-4 px-2">
                                    ...
                                    <div class="star-block">
                                        ...
                                        <ul class="rating_list py-1" :rating="hotel.star_classification"> 
                                            ...
                                            <!-- <li class="active"><svg-icon icon="star" :hasFill="true"></svg-icon></li>
                                            <li class="active"><svg-icon icon="star" :hasFill="true"></svg-icon></li> -->
                                        </ul>
                                    </div>
                                </div>
