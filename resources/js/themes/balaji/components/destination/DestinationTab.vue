     ...
     <destination-tab-wrapper class="tab-panel">
        <div class="xl:container xl:mx-auto">
            <div class="tab">
                ...
                <button v-if="destination.images" class="tablinks uppercase" :class="activeId == 'dest_gallery' ? 'active' : ''" @click="handleActive('dest_gallery')">Photo Gallery</button>
            </div>
            <div id="dest_about" class="tabcontent" v-if="activeId == 'dest_about'">
                <div class="">
                    <div class="destination_about_content">
                        ...
                        <div class="text-justify font-normal" v-html="destination.description">
                        </div>
                    </div>
                </div>
            </div>
