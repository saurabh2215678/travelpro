<template>
    <div class="right_price_box">
        <form id="bookNowForm">
            <div class="par_cost pb-2 text-sm">From <span>{{showPrice(this.startingPrice)}}</span> per person</div>
            ...
            <div class="single_package_day">
                <ul class="form_list w-full float-left mt-2">
                    <li class="w-2/4" v-if="this.package_tour_type != 'open' && this.isOnlineBooking('activity_listing')">
            ...
            <div class="slot_time" v-if="this.package_tour_type != 'open' && this.isOnlineBooking('activity_listing')">
            ...
            <div class="booknow_btn ">
                ...
                <div class="price_box" v-if="this.isOnlineBooking('activity_listing')">
                ...
                <ul class="btn_group listing_btn">
                    <li>
                        ...
                        <input type="button" class="btn w-full" name="submit" value="Book Online" @click="bookNow" v-if="this.isOnlineBooking('activity_listing')">
                    </li>
...
export default {
            ...
            .then(function (resp) {
                    ...
                    if(response && response.success) {
                        ...
                        if(response.packageSelectedPrice) {
                            currentObj.packageSelectedPrice = response.packageSelectedPrice;
                            currentObj.typename = response.packageSelectedPrice.title;
                            currentObj.package_total_price = response.packageSelectedPrice.final_amount;
                            currentObj.package_booking_price = response.packageSelectedPrice.booking_price;
    ...
    layout: Layout,
    props: ["package","faq_row","destinations","itenaries", "calenderPop", "showCalenderPopup", "hideCalenderPopup","sharing_links"],
};
