<template>
    <form-wrapper :action="store.websiteSettings?.PACKAGE_URL" method="GET" name="searchForm" class="" id="search_packages_form" @submit="validateSearchPackageForm">
         ...
         <div class="flex ">
            ...
            <div class="searchbtn">
               ...
               <button type="submit" class="btn btn-primary btn_lg" ><img src="../../assets/images/search_icon.png"></button>
               <button type="submit" class="btn btn-primary btn_mb" >Search</button>
            </div>
         </div>
    </form-wrapper>
</template>
