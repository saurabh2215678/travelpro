<template>
    <!-- <SearchForm /> -->
    <section class="single_package_details py-0 mb-5">
                            ...
                            <div class="form_box">
                                <div :class="`flex items-center flex-wrap justify_btwn ${(package?.packagePrices?.length > 0)?'':'no_price'}`">
                                    ...
                                    <FancyboxWrapper className="left_price_box">
                                        <div class="swiper package_detail_img" v-if = "package?.images?.length > 0">
                                        ...
                                        <div class="no_imges" v-else>
                                            <img src="/assets/balaji/images/noimage.jpg" style="object-fit: cover;
"/>
                                        </div>
                                    </FancyboxWrapper>
                ...
                <div class="xl:container xl:mx-auto">
                    <div class="flex flex-wrap">
                        <div class="row-cols-2 w-70 pr-9">
                            ...
                            <!--- ======== Description  ======== -->
                            <div class="package_disc overview_box py-3.5 px-5" v-if="package.brief || package.description">
                            ...
                            <!--- ======== Package Days  ======== -->
                            <PackageDayWrapper class="package_day secpad mt-5" v-if="this.package_itenaries && this.package_itenaries.length > 0 && package.is_activity == 0">
                                        ...
                                        <ul>
                                            <li class="faq_main" v-for="itenary in this.package_itenaries"> 
                                                <div class="ml-14">
                                                    ...
                                                    <div class="faq_data">
                                                        <div class="faq_service package_disc overview_box py-3.5 px-5 mb-3" v-if="itenary.itenary_inclusions_arr && itenary.itenary_inclusions_arr.length > 0">
                            ...
                            <!--- ======== Accommodation  Old ======== -->
                            <div class="accommodation accordion pt-5" v-if="this.packagePolicy()">
    ...
    <section class="home_featured latoFont pt-0" v-if="this.similarPackages && this.similarPackages.length > 0">
        <div class="xl:container xl:mx-auto">
    ...
    <section class="departure_single" v-if="destinations && destinations.length > 0">
        <div class="xl:container xl:mx-auto">
