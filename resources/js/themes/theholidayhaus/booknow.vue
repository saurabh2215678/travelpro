<template>
    <!-- <SearchForm /> -->
    <BookNowWrapper class="theme_form allbooking_form mt-7">
            ...
            <form id="book_now_form" method="POST" autocomplete="off" @submit="handleFormSubmit">
                ...
                <div class="form_inner">
                    <div class="form_price">
                        <div class="left_form w-4/6 pr-5">
                            <div class="left_sec logincard" v-if="!userLoggedIn">
                                <ul class="flex items-center">
                                    <!-- <li class="pr-2"><img src="../../assets/login-globe-icon.png"></li> --> 
                                    <li><!--<strong>Sign in to use your {{store.websiteSettings?.SYSTEM_TITLE}} Cash!</strong>--> <span class="text-sm mr-1"><strong>Signing in to your {{store.websiteSettings?.SYSTEM_TITLE}} account allows for faster bookings.</strong></span></li>
                                    <li class="w-20"><span class="text-sm"><a class="text-teal-500 underline font-bold" :href="`${store.websiteSettings?.FRONTEND_LOGIN_URL}?redirect_url=${this.back_url}`">Sign in</a></span></li>
                                </ul>
                            </div>
                            <div class="left_sec">
                            ...
                            <div class="form_list">
                                ...
                                <div class="mb-0 w-full p-2">
                                    <div class="form_group">
                                        <p class="text-xs">By proceeding with this booking, I agree to {{store.websiteSettings?.SYSTEM_TITLE}}'s <a :href="store.websiteSettings?.TERMS_SERVICE_LINK"><b>Terms of Use</b></a> and <a :href="store.websiteSettings?.PRIVACY_LINK"><b>Privacy Policy.</b></a></p>
                                    </div>
                                </div>

                                
                            </div>
                            <div class="mb-0 w-1/2 p-2">
                                <div class="form_group">
...
import {BookNowWrapper} from './styles/BookNowWrapper';
