                    ...
                    <div class="banner_content">
                        <div class="container">
                            <div class="slider-caption">
                                <div class="slider_para font23 mb-5" v-html="image?.sub_title"></div>
                                <div class="slider_heading font65 fw700 tracking-wide" v-html="image?.title"></div>
                                <a class="btn_banner font18 fw600" :href="image?.link_1" v-if="image?.link_1"> 
