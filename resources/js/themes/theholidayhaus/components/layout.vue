...
export default {
    ...
    updated() {
        ...
        var meta_description = (store.seoData?.meta_description !== '') ? store.seoData?.meta_description : '';
        var meta_keyword = (store.seoData?.meta_keyword !== '') ? store.seoData?.meta_keyword : '';

        if(meta_title != '' && meta_title != undefined){
            document.title = store.seoData?.meta_title;
        }
        if(meta_description != '' && meta_description != undefined){
            if(document.head.querySelector('meta[name="description"]') && store?.seoData?.meta_description){
        ...
        if(meta_keyword != '' && meta_keyword != undefined){
            if(document.head.querySelector('meta[name="keywords"]') && store.seoData?.meta_keyword){
