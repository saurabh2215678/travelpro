        ...
        <td colspan="6">
            <SlideUpDown :duration="400">
                <div class="det_wrap">
                    ...
                    <div class="det_content_wrap" v-if="this.tabData.tripInfos">
                        
                        <div class="det_content" v-if="activeTab == 1 && !hideFlightTab">
                            <template v-for="tripInfo,index in this.tabData.tripInfos">
                        ...
                        <div class="det_content" v-if="activeTab == 2">
                            <div class="fare_detail_bx">
                                <element v-for="(tripInfo, index) in this.tabData.tripInfos">
                                ...
                                <table>
                                    ...
                                    <tbody v-for="tripPrice in tripInfo.totalPriceList">
                                        ...
                                        <tr v-if="tripPrice.fd[paxType.key]['fC']['BF']">
                                            ...
                                            <td>{{showPrice(tripPrice.fd[paxType.key]['fC']['BF'])}}  x {{tabData.searchQuery.paxInfo[paxType.key]}}</td>
                                            <td>{{showPrice(tripPrice.fd[paxType.key]['fC']['BF'] * tabData.searchQuery.paxInfo[paxType.key])}}</td>
                                        </tr>
                                        <tr style="z-index: 5;" >
                                                ...
                                                <Popper hover arrow>
                                                    ...
                                                    <template #content>
                                                        <div class="tooltip_details">
                                                            ...
                                                            <div class="flex"><span class="me-4">Other Taxes</span> <span class="ms-auto">{{showPrice((tripPrice.fd[paxType.key]['afC']['TAF']['OT']??0)+this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier))}}</span></div>
                                                            ...
                                                            <div class="flex" v-if="this.getAgentMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier) > 0"><span class="me-4" >Markup</span><span class="ms-auto">{{showPrice(this.getAgentMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier))}}</span></div>

                                                            <div class="flex" v-if="this.getAgentDiscountPrice(this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier),tabData.searchQuery,null,tripPrice.fareIdentifier) > 0"><span class="me-4" >Discount</span><span class="ms-auto">-{{showPrice(this.getAgentDiscountPrice(this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier),tabData.searchQuery,null,tripPrice.fareIdentifier))}}</span></div>
                                                        </div>
                                                    </template>
                                                </Popper>
                                            </td>
                                            <td>{{showPrice(tripPrice.fd[paxType.key]['fC']['TAF']+this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier)+this.getAgentMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier)-this.getAgentDiscountPrice(this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier),tabData.searchQuery,null,tripPrice.fareIdentifier))}} x {{tabData.searchQuery.paxInfo[paxType.key]}}</td>
                                            <td>{{showPrice((tripPrice.fd[paxType.key]['fC']['TAF']+this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier)+this.getAgentMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier)-this.getAgentDiscountPrice(this.getSupplierMarkupPrice(tripPrice.fd[paxType.key]['fC']['BF'],tabData.searchQuery,null,tripPrice.fareIdentifier),tabData.searchQuery,null,tripPrice.fareIdentifier)) * tabData.searchQuery.paxInfo[paxType.key])}}</td>
                                        </tr>
                                        </template>
                                        </template>
                        ...
                        <div class="det_content" v-if="activeTab == 3">
                            ...
                            <element  v-if="this.tabData.tripInfos"  v-for="(tripInfo, index) in this.tabData.tripInfos">
