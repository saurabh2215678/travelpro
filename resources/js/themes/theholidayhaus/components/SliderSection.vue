<template>
    <SliderSectionWrapper class="home_featured mt-5 pb-0" :class="className">
        <div class="container">
                        ...
                        <div class="swiper-slide" v-for="row in sectionData.data">
                            <div class="tour_category_box">
                                ...
                                <div v-else-if="row.name" class="featured_content subhead">
                                  <a class="images" :href="row?.url || row?.slug">
                                    <div class="title font21 fw600" v-html="row.name"></div>
                                    <div class="count-dist font14 text-center">{{row?.package_count}} Tour Packages</div>
                                 </a>
                                </div>
                            </div>
                        </div>
