<template>
    <TestimonialWrapper id="review" class="home_testimonial home_featured mt-7 pt-2 py-3.5 px-2 border border-gray-300 rounded bg-white" v-if ="testimonials">
        <div class="container">
            ...
            <div class="view_all_btn flex justify-center"><a :href="store.websiteSettings?.TESTIMONIAL_URL">View All</a></div>
        </div>
    </TestimonialWrapper>
</template>
