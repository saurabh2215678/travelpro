<template>
    <form @submit.prevent="handleSubmit" class="rts_flight">
        ...
        <div class="fts_top" ref="cabRef">
            ...
            <p>By proceeding to book, I Agree to {{routeInfo.app_name}} <Link :href="store.websiteSettings?.PRIVACY_LINK" target="_blank">Privacy Policy</Link> and  <Link :href="store.websiteSettings?.TERMS_SERVICE_LINK" target="_blank">Terms of Service</Link></p>
