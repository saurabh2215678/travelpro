    ...
    <div class="container">
        ...
        <div class="footer_bottom_right w_40">
                ...
                <div class="footer_heading text-lg mb-5">Contact Us</div>
                  <ul class="links_list">
                      ...
                      <li class="pb-2.5">
                        ...
                        <i class="fa-regular fa-envelope mt-1"></i> {!! $email !!}
                        </div>
                      </li>
            ...
            <div class="footer_bottom_left">
              ...
              <div class="footer_heading text-lg mb-5">Call Back Request</div>
            ...
            <img alt="Andaman Islands" src="{{ asset(config('custom.assets').'/img/brand_left.png') }}"> 
            </div>
        </div>
        
</div>
<div class="copyr inline-block w-full bg-gray-900 p-3 bg-black text-sm text-white">
         <div class="container"> 
          <div class="flex">
            <div class="w-1/2"> 
