...
<section class="pt-2">
   <div class="container">
      <div class="<?php if(isset($itineraries) && isset($paymentData['status']) && $paymentData['status'] == 1){?>flight-payment-detail<?php }else{ ?>flight-payment-detail<?php } ?>">
         <div class="row">
               ...
               <table width="1100">
                  <thead>
                     ...
                     <tr>
                        ...
                        <td style="">Rs.
                        {{CustomHelper::getPrice($hotel_data['hotel_charge']??'')}}</td>
                     </tr>
                     <tr>
            ...
            <div style="width:100%; text-align: left;">
               ...
               <a href="{{route('homePage')}}" class="btn" style="margin-top: 8px; margin-left: 21px; margin-bottom: 20px;">Go to Home</a>
            </div>
         </div>
      </div>
   </div>
