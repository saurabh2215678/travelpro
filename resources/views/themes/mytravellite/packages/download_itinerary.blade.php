...
@page {       
   ...
   .footer_add a, .footer_add {color:#fff;text-decoration:none;font-size: 13px;}
...
.faq_main  .faq_data, .faq_data, .faq_data p{
   ...
   ul li ul{padding-left:15px;list-style-type: disc;}
   ul.inclusions li {
      text-align: center;
      width: 30px;
                  ...
                  <tr>
                     <td colspan="2">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" class="cke_show_border" style="margin-top:10px;">
                           <tbody>
                              <tr style="background-color: #0078c21c;">
                                 ...
                                 <td style="border-bottom:1px solid #000;padding:15px;margin-top:10px;">
                                    <div style="text-align:right;color: #222222;">
                                       <span style="color: #222222; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 12px;">Phone: {{$agent_phone}}</span><br>
                                       <span style="color: #222222; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 12px;">E-mail: <a href="mailto:{{$agent_email}}" style="color: #222222; font-family:Arial, sans-serif; font-style: normal; font-weight: bold; text-decoration: none; font-size: 12px;text-decoration:none;"> {{$agent_email}} </a></span>
                                    </div>
                                 </td>
                              </tr>
                              <tr>
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <?php } ?>
                                   ...
                                   <?php 
                                    if($online_booking){
                                       if($is_agent != 1 && isset($booking_data['booking_price']) > 0 && isset($booking_data['total_pax']) > 0){ ?>
                                          <tr>
                                             <td style="padding: 2px 5px 2px 5px;">
                                                <p style="color: #000; font-size: 13px; font-family: Arial, sans-serif; margin: 4px 0px;"><strong>Booking Amount : </strong>Rs. {{isset($booking_data['booking_price'])*isset($booking_data['total_pax'])}}</p>
                                             </td>
                                          </tr>
                                       <?php }
                                    }?>
               ...
               <?php if(!empty($package_itenaries) && count($package_itenaries) > 0 && $package->is_activity==0){ ?>
                  ...
                  <ul style="padding:0;">
                     <?php foreach ($package_itenaries as $itenary) {
                        ...
                        //$itenaryThumbSrc = asset(config('custom.assets').'/images/noimage.png');
                        if(!empty($itenary_image)){
                           if($storage->exists($itenaries_path.$itenary_image)){
...
<div style="clear: both;"></div>
               ...
               <ul class="toggle_inner" style="padding-left:0; list-style-type: disc;">
                  <li class="faq_main" style="list-style-type: disc;">
      ...
      <td valign="top" colspan="2" style="width:200px;">
        <!-- <p class="text-lg">Ticket Booking or Enquiry:</p> -->
         <div class="footer_add" style="display: inline-block;font-family: Arial, sans-serif;width:200px;">
            <img src="{{ public_path(config('custom.assets').'/img/telephone.png') }}" alt="Phone" style="width:14px;margin-right:5px;float:left;position: relative;top:5px;"> {!! $phone !!}
         </div>
         <div class="footer_add" style="display: inline-block;font-family: Arial, sans-serif;width:200px;">
         ...
         <td colspan="2" style="width:200px;">
            ...
            <div class="adrs_mt footer_add" style="font-family: Arial, sans-serif;"><img src="{{ public_path(config('custom.assets').'/img/location.png') }}" alt="Phone" style="width:12px;margin-right:5px;"> {!! $address !!}</div>
         </td>
      </tr>
   </table>
<?php } ?>
