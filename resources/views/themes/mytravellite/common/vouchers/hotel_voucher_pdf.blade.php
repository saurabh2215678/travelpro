			...
			<tbody>
				...
				<tr>
					<td colspan="3" style="padding: 16px 15px 2px 15px;"><span style="font-size: 24px; color: #3f4041; font-family: 'Roboto', sans-serif, Arial;">Dear {customer_name},</span>
						<p style="font-size: 13px;font-family: 'Roboto', sans-serif, Arial;color: #2b2c2c;line-height: 20px;margin-bottom: 8px;margin-top: 0;">Thank you for choosing Andaman Island</p>
				...
				<tr>
					<td style="padding: 2px 15px 2px 15px;">
						...
						<p style="font-size: 14px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 10px 0px;color: #333;width: 270px;"><strong>Address:</strong> {address}</p>
					...
					<td style="padding: 2px 15px 2px 15px;">
						...
						<p style="font-size: 14px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 4px 0px;color: #333;text-align: center;">{checkin_time}</p>
					...
					<td style="padding: 2px 15px 2px 15px;">
						...
						<p style="font-size: 14px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 4px 0px;color: #333;text-align: center;">{checkout_time}</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
				<td colspan="3" style="border: 0;background-color: #0078c21c;">
					<table border="0" cellpadding="0" cellspacing="0" width="700" class=" cke_show_border">
						<tbody>
							<tr>
				...
				<tr>
					<td colspan="3">{contact_details}</td>
				</tr>
				</tbody>
			</table>
		</div>
