...
<?php
$websiteSetting = CustomHelper::getSettings(['FACEBOOK','TWITTER','INSTAGRAM','LINKEDIN','YOUTUBE','HTML_VALIDATION','FRONTEND_LOGO','SITE_ADDRESS','SITE_EMAIL','SITE_PHONE','SITE_PHONE1','SITE_PHONE2','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY','FOOTER_TEXT']);
...
$FOOTER_TEXT = $websiteSetting['FOOTER_TEXT']??''; 
...
<footer class="theme_footer">
    ...
    <div class="heading2 text-center pb-8">Sign up to our newsletter</div>
        <div class="newslateer_inner">
            <div class="newsletter_right">
                ...
                <button class="btn subscribeBtn">Subscribe Now</button>
            </div>
        </div>
    </div> 
</footer>
    ...
    <div class="xl:container xl:mx-auto">
        <div class="footer_bottom_inner pb-6">
            <div class="footer_bottom_left">
              <div class="footer_logo w-36"><a href="{{url('/')}}"><img src="{{ $logoSrc }}" /></a></div>
              <p>{{$FOOTER_TEXT}}</p>
                <ul class="social_icon my-5">
                <?php if($facebook){ ?>
            ...
            <div class="footer_bottom_right w_40">
              {!! $menuItemsList !!}
            </div>
            <?php /*
                  ...
                  <ul class="links_list">
                      <li class="pb-2.5">
                        <div class="footer_icon mr-2.5">
                          <img src="{{ asset(config('custom.assets').'/img/mapicon.png') }}" style="width: 2.2rem;">
                        </div>
                      ...
                      <li class="pb-2.5">
                        <div class="footer_icon mr-2.5">
                          <img src="{{ asset(config('custom.assets').'/img/phoneicon.png') }}">
                        </div>
                        <div class="footer_add">
                          {!! $phone !!}
                      </div>
                      ...
                      <li class="pb-2.5">
                        <div class="footer_icon mr-2.5 text-center">
                          <img src="{{ asset(config('custom.assets').'/img/mailicon.png') }}"> 
                        </div>
                        <div class="footer_add">
                        {!! $email !!}
                      </div>
            ...
            <div class="footer_brand py-5 text-center">
            <div class="copyright text-sm"> Copyright &copy; {{ date('Y') }} Grand India Tour </div>
              <!-- <div class="design_by text-sm">Design By : <a href="#"> Indiainternets</a> </div> -->
              <!-- <ul>
                <li><img src="{{ asset(config('custom.assets').'/img/brand_left.png') }}"> </li>
                <li><img src="{{ asset(config('custom.assets').'/img/members.png') }}" alt="Members" class="img-responsive"></li>
              </ul> -->
            </div>
        </div>
</div>
...
$('header .theme-nav > li a').each(function(){
