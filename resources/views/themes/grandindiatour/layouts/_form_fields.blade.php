...
switch ($element->type) {
	case 'name':
	?>
	<div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label><input type="text" placeholder="{{$placeholder}}" {{($validation=='required')?'required':''}} class="form-control {{$classNameInner}}" dataTypeInput="input{{$element->type}}" name="input{{$id}}" value="{{old('input'.$id)}}" /><span class="input{{$id}}_error error"></span></div>
	<?php
	break;

case 'email':
?>
<div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label><input type="email" placeholder="{{$placeholder}}" {{($validation=='required')?'required':''}} class="form-control {{$classNameInner}}" dataTypeInput="{{$element->type}}" name="input{{$id}}" value="{{old('input'.$id)}}" /><span class="input{{$id}}_error error"></span></div>
<?php
break;

case 'phone':
?>
<div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label>
...
case 'country':
?>
<div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label><select class="form-select {{$classNameInner}}" {{($validation=='required')?'required':''}} name="input{{$id}}">
	<?php
...
case 'number':
?>
<div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label><input type="text" {{($validation=='required')?'required':''}} placeholder="{{$placeholder}}" class="form-control {{$classNameInner}}" dataTypeInput="{{$element->type}}" name="input{{$id}}" value="{{old('input'.$id)}}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" /><span class="input{{$id}}_error error"></span></div>
<?php
break;

case 'textarea':
?>
<div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label><textarea placeholder="{{$placeholder}}" {{($validation=='required')?'required':''}} class="form-control {{$classNameInner}}" dataTypeInput="{{$element->type}}" name="input{{$id}}" style="height: 100px;">{{old('input'.$id)}}</textarea><span class="input{{$id}}_error error"></span></div>
<?php
break;

	case 'text_only':
?><div class="form-floating mb-3 {{$className}}"><label for="{{$name}}">{{$name}}</label><div>{{$data}}</div><span class="input{{$id}}_error error"></span></div>
<?php
break;
