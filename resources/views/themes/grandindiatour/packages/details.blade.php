      ...
      <div class="container mx-auto">
         <div class="flex flex-wrap">
            <div class="row-cols-2 w-70 pr-9">
               ...
               <div class="package_disc bg-slate-100 mt-3 p-4">
               <div class="text-xl font-bold pt-3">{{count($PackageFlights)}} Flights in the package</div>
               <p class="para_lg2">
                  ...
                  <div class="container-full">
                     ...
                     <div class="faqlist faqlist_in">
                        ...
                        <?php foreach ($package_itenaries as $itenary) {
                           ...
                           <li class="faq_main">
                              <div class="ml-14">
                                 <div class="faq_title">{!! $itenary_title !!}</div>
                                 ...
                                 <div class="faq_data">
                                    ...
                                    <div class="faq_service package_disc overview_box py-3.5 px-5 mb-3">
                                    ...
                                    @if(!empty($itenarySrc))
                                    <div class="left-img-itinerary float-left mr-6"><img class="rounded-lg" src="{{ $itenarySrc }}" alt="{{$itenary_title}}" /></div>
                                    @endif

                                    @if($itenary_location)
                                    <div class="text-lg font-semibold">{{$itenary_location}}</div>
                                    @endif
                                    <div class="right-content-itinerary text-sm inline">{!! $itenary_description !!}</div>
                                 </div>
                              </div>
                           </li>
                           <?php } ?>
                     ...
                     <div class="faqlist">
                        ...
                        */ ?>
                        ...
                        @if(!empty($faq_row) && count($faq_row) > 0)
                            <br><br><div class="theme_title mb-0">
...
<section class="home_testimonial package_testi m-5">
 <div class="container">
   <div class="theme-title text-center mb-3">
      <div class="text-xl font-semibold">Testimonials</div>
   </div>
...
<section class="accommodation_single mt-5" style="padding:25px 0; background:#f2f2f2;">
   <div class="container">
      <div class="text_center">
      <div class="theme_title mb-3">
         <div class="text-xl font-semibold">Similar {{$is_activity==1?'Activity':'Packages'}}</div>
      </div>
      </div>
...
<section class="departure_single">
   ...
   <div class="text_center">
      <div class="theme_title mb-3">
         <div class="text-xl font-semibold">More Trips Departure</div>
      </div>
      </div>
      <div class="slider_box mt20">
