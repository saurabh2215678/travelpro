...
<section class="paynow-template">
   ...
   <form method="POST" id="paynow_form" onSubmit="return validatePayNow();">
      ...
      <div class="row">
      <div class="col-sm-12">
         <div class="title text-2xl uppercase my-3">Review Booking Details</div>
         <div class="row">
            <div class="col-sm-7 w-3/5">
               ...
               <?php if($order->order_type == 3 || $order->order_type == 4 || $order->order_type == 5 || $order->order_type == 7 ){ ?>
               <?php }else{ ?>
                  ...
                  <div class="table_view">
                     <table class="table table-striped table-bordered text-sm">
                        <tbody>
                          ...
                          <?php if($discount_coupon && $discount_coupon > 0){ ?>
                           <tr class="total_fee">
                     ...
                     <div class="bkg_btm">
                        <div class="booking_details">
                           <table>
                              ...
                              <?php } ?>
                              <?php  if($order->discount_coupon && $order->discount_coupon > 0){ ?>
                                 <tr>
...
<script type="text/javascript">  
   ...
   $(document.body).addClass('headerType');
