    ...
    <div class="signup_form singup_form_wrap">
        <div class="singup_form_inner">
           ...
           <div class="form_group">
            ...
            <div class="form_group">
                <label class="control-label required text-xs">Upload PAN Card<em>*</em></label>
           ...
           <div class="form_group">
                <label for="destinations_sell_most" class="control-label required text-xs">Destinations you sell the most<em>*</em></label>
