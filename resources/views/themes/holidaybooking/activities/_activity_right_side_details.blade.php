...
<form id="myForm">
   ...
   <div class="form_box">
     ...
     <ul class="form_list w-full float-left">
                  ...
                  ?>
               @if($package_tour_type != 'open' && Customhelper::isOnlineBooking('activity_listing'))
         ...
         <ul class="btn_group mt-2 customize_btn">
               </ul>
            ...
            <div class="slot_time">
            <a class="apply_slot" href="#" id="applyTripTravellers">Apply</a>
...
$('.select_trav').click(function(){
      $(this).siblings(".single_package_white").toggleClass('active');
});
