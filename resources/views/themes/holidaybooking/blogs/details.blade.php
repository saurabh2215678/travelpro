...
if($bannerType == 'desktop'){
   $b_image = asset(config('custom.assets').'/images/blog_details_banner.jpg');
...
<style>
   .blog_form .form-floating {padding: 0 5px;}
.btnSubmit{margin-top: 2rem;}
</style>
