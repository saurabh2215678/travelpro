...
// $b_image =asset(config('custom.assets').'/images/noimgbanner.jpg');
// if($banner_image) {
              ...
              <div class="breadcrumb_full">
               <div class="container">
                  <ul class="breadcrumb">
                     ...
                     <li><a href="{{route('blogsListing')}}" hreflang="en">{{$page_url_label}}</a>
                     </li>
               ...
               <div class="swiper latest_blog_slider">
                  ...
                  <?php
                     ...
                     foreach($featured_blogs as $blog){
                        ...
                        $blogToCategory = $blog->blogToCategory??[];
                        ...
                        <a href="{{$url}}" hreflang="en">
                           ...
                           <div class="latest_blog_content text-center px-1.5 py-3.5" data-swiper-parallax="-200">
                              ...
                              <!-- <ul class="blog_info">
                                 ...
                                 <li>
                                    <div class="author_name"><a href="{{route('blogsListing',$category_id)}}" hreflang="en">{{ isset($blog->Category->name) ? $blog->Category->name:''  }}</a></div>
                                 </li>
           ...
           <?php if(!empty($normal_blogs) && count($normal_blogs) > 0) { ?>
            <?php /*<div class="text_center">
               <div class="theme_title mb-6">
                  ...
                  <!-- <div class="view_all_btn"><a href="http://localhost:8000/blog" hreflang="en">View All</a></div> -->

               </div>
            </div>*/ ?>
            <div class="d-flex blog_list_flex">
                  ...
                  <ul class="blog_list">
                     ...
                     <li class="lg:w-1/3 mt-5">
                        <a href="{{$url}}" hreflang="en" class="latest_blog">
                           ...
                           <div class="latest_blog_content text-center px-1.5 py-3.5">
                              ...
                              <h3 class=" text-lg">{{ $blog_title }}</h3>
                              <!-- <ul class="blog_info">
                  ...
                  <form action="{{ route('blogsListing') }}" method="GET" id="adv_blogs_search" name="adv_blogs_search">
                  <div class="side_bar">
                     <div class="filter_box">
                        <div class="title para_md">Categories </div>
                           @if(isset($blog_category_data) && !empty($blog_category_data))
                           @foreach($blog_category_data as $blog_cat)
                           <div class="checkbox_list">
                              <a href="{{route('blogsListing',[$blog_cat->slug])}}" hreflang="en"> {{$blog_cat->name ?? ''}}</a>
                           </div>
                           @endforeach
                           @endif
                              <!-- <div class="checkbox_list">
