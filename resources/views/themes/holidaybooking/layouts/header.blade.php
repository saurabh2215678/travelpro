...
//prd(CustomHelper::getSettings('RECAPTCHA_SITE_KEY'));
  $websiteSettingsArr=CustomHelper::getSettings(['FRONTEND_LOGO','FRONTEND_LOGO_AlT_TEXT','SITE_EMAIL','WHATSAPP1','WHATSAPP2','GOOGLE_TRANSLATOR_MANAGEMENT','SALES_PHONE','SALES_EMAIL']);
   ...
   $menuItemsList = CustomHelper::getMenuForFront($menuItems, $is_parent = true, $parent_class='theme-nav', $child_class='sub_menu_li', $child_parent_class='sub-menu', $have_child_class='has-dropdown' , $dropdown_menu='dropdown_sub_menu');
   //prd($menuItemsList);
