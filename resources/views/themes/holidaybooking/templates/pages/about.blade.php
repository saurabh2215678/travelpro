   ...
   <div class="container">
      <div class="row">
         <!-- <div class="theme_title">
               <h2 class="title2 text-3xl pb-5">Magical memories, Bespoke experiences</h2>
               <hr>
         </div> -->
         <div class="col-lg-7">
            <div class="top_about">
         ...
         <div class="col-lg-5">
            <img class="img-fluid" src="{{asset(config('custom.assets').'/images/about_top.jpg')}}" alt="Best Tour Operator in Delhi, NCR"/>
         </div>

         <div class="fact_grid d-none">
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact1.png')}}" alt=""> </div>
               <div class="text para_lg2">Best Track Record</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact2.png')}}" alt=""> </div>
               <div class="text para_lg2">High Quality Service</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact3.png')}}" alt=""> </div>
               <div class="text para_lg2">Professional Trip Management</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact4.png')}}" alt=""> </div>
               <div class="text para_lg2">Highly Experienced Guides</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact5.png')}}" alt=""> </div>
               <div class="text para_lg2">Customized Tour Packaging</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact6.png')}}" alt=""> </div>
               <div class="text para_lg2">Deep Local Knowledge</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact7.png')}}" alt=""> </div>
               <div class="text para_lg2">Personalized Service</div>
            </div>
            <div class="col-md-3 box">
               <div class="iocn"><img src="{{asset(config('custom.assets').'/images/fact8.png')}}" alt=""> </div>
         ...
         <div class="container">
            ...
            <div class="about_top">
               <div class="about_left">
                  <img class="img-responsive" src="{{asset(config('custom.assets').'/images/Beautiful-Mauritius-Beaches.jpeg') }}" alt="" >
               </div>
           
               <div class="about_right" id="fade_anchor">
                  <ul class="fact_list">
                     <li data-aos="fade-left" data-aos-duration="1000"  data-aos-anchor="#fade_anchor">
                        <div class="iocn"><img src="{{asset(config('custom.assets').'/images/Core-Values.png')}}" alt=""> </div>
                     ...
                     <li data-aos="fade-left" data-aos-duration="1200" data-aos-anchor="#fade_anchor">
                        <div class="iocn"><img src="{{asset(config('custom.assets').'/images/Mission.png')}}" alt=""> </div>
                     ...
                     <li data-aos="fade-left" data-aos-duration="1400" data-aos-anchor="#fade_anchor">
                        <div class="iocn"><img src="{{asset(config('custom.assets').'/images/Vision.png')}}" alt=""> </div>
      ...
      <section class="benchmarks_area d-none" style="background-image: url({{asset(config('custom.assets').'/images/about-bg.jpg') }}) ">
         <div class="container">
      ...
      <section>
         <div class="container">
            <div class="row">
               <ul class="mission_flex">
                  <li data-aos="fade-up" data-aos-duration="2000">
                     <img class="img-fluid about-img" src="{{asset(config('custom.assets').'/images/about-mission.jpg')}}" alt="">

                     <h3 class="title text-3xl pb-3 abt_heading">Our Mission</h3>
                     <p>With the mission to "conquer the travel world by extending its wings of quality service," Holidays booking seeks to make it feasible for its customers to go to any part of the globe by providing excellent tourist services.</p>
                     <p>To give excellent customer service.</p>
                     <ul style="padding:0">
                        <li>To maintain market dominance for domestic tours in Southern and Northern India.</li>
                        <li>To ensure that our consumers receive value for their money and expectations are met.</li>
                        <li>To continuously enhance the organisational procedures for customer service.</li>
                        <li>To assure the safety and security of our consumers while travelling with us.</li>
                        <li>To adhere to the organization's legal and other regulatory standards.</li>
                        <li>To establish a positive working atmosphere for the employees and enable them to increase their performance levels consistently.</li>
                     </ul>
                  </li>
                  <li data-aos="fade-up" data-aos-duration="2000">
                     <img class="img-fluid about-img" src="{{asset(config('custom.assets').'/images/about-vision.jpg')}}" alt="">
                     <h3 class="title text-3xl pb-3 abt_heading">Our Vision</h3>
                     <p>Travel enables you to realize your highest potential because exploring the unknown and interacting with new experiences are innately human characteristics. Holidays booking keeps the spirit in mind and strives to create the most affordable corporate tourism worldwide. We aspire to usher in a new era of corporate tours worldwide. As a result, we have received acclaim from clients in our domain for our innovative travel services.</p>
                     <p>Holidays booking views the world from the perspective of a curious traveller. We know precisely what it takes to provide the finest travel services. Our exceptional staff works dynamically to create inexpensive and memorable corporate tours. Therefore, we modestly proclaim, "Our Vision Is Our Clients' Vision."</p>
                  </li>
            </ul>
            </div>
         </div>
      </section>
      <section class="accommodation_sec" id="why-choose-us">
         <div class="container">
            <div class="theme-title text-center">
               <div class="title text-3xl pb-5">WHY CHOOSE US</div>
            </div>
            <ul class="accommodation_list">
               <li data-aos="fade-up" data-aos-duration="2000">
                  <div class="accommodation_box">
                     <div class="top_title">
                        <div class="icon"><img src="{{asset(config('custom.assets').'/images/about-icon1.png')}}" alt=""></div>
                        <div class="title para_lg1">Superior Care & Service</div>
                     </div>
                     <p class="para_md">Experienced and knowledgeable Tour Escorts, accompanying you for the duration of the group tour, will take every precaution to make your vacation as perfect and carefree as possible.</p>
                  </div>
               </li>
               <li data-aos="fade-up" data-aos-duration="2000">
                  <div class="accommodation_box">
                     <div class="top_title">
                        <div class="icon"><img src="{{asset(config('custom.assets').'/images/about-icon2.png')}}" alt=""></div>
                        <div class="title para_lg1">Time And Effort Savings</div>
                     </div>
                     <p class="para_md">Vacation planning may be a difficult endeavour. Allow us to do the work! By selecting us, you can save time and effort by booking your entire trip directly with a specialised local agency.</p>
                  </div>
               </li>
               <li data-aos="fade-up" data-aos-duration="2000">
                  <div class="accommodation_box">
                     <div class="top_title">
                        <div class="icon"><img src="{{asset(config('custom.assets').'/images/about-icon3.png')}}" alt=""></div>
                        <div class="title para_lg1">Local Expertise</div>
                     </div>
                     <p class="para_md">It is essential to us that our vacations provide you with a memorable and genuine experience. In accordance with the expectations we have for our employees, we select only local suppliers who are approachable, reputable, and have in-depth knowledge of the local area.</p>
                  </div>
               </li>
               <li data-aos="fade-up" data-aos-duration="2000">
                  <div class="accommodation_box">
                     <div class="top_title">
                        <div class="icon"><img src="{{asset(config('custom.assets').'/images/about-icon4.png')}}" alt=""></div>
                        <div class="title para_lg1">Friendly And Knowledgeable Staff</div>
                     </div>
                     <p class="para_md">Holidays booking has provided remarkable travel experiences for thousands of clients from all over the India since its inception. This is due to the calibre of our personnel. Our employees have substantial, firsthand knowledge of the region and are enthusiastic about their work.</p>
                  </div>
               </li>
               <li data-aos="fade-up" data-aos-duration="2000">
                  <div class="accommodation_box">
                     <div class="top_title">
                        <div class="icon"><img src="{{asset(config('custom.assets').'/images/about-icon4.png')}}" alt=""></div>
                        <div class="title para_lg1">What Separates Holidays booking From Others?</div>
                     </div>
...
<?php if(!$blogs->isEmpty()){ ?>
      <!-- BLOG SECTION START -->
      <section class="home_blog d-none">
         <div class="container">
            <div class="row">
               ...
               <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                     <a class="blog_box" href="{{route('blogsDetail',['slug'=>$blog->slug])}}">
                        <img class="theme_radius" src="{{ $blogThumbSrc }}" />
                        <div class="text">
         ...
         <ul class="organizations_list">
            <li>
               <div class="organizations_box">
                  <img src="{{asset(config('custom.assets').'/images/organizations-img3.jpg')}}" alt="">
               </div>
            </li>
            <li>
               <div class="organizations_box">
                  <img src="{{asset(config('custom.assets').'/images/organizations-img2.jpg')}}" alt="">
               </div>
            </li>
            <li>
               <div class="organizations_box">
                  <img src="{{asset(config('custom.assets').'/images/organizations-img1.jpg')}}" alt="">
               </div>
            </li>
            <li>
               <div class="organizations_box">
                  <img src="{{asset(config('custom.assets').'/images/organizations-img4.jpg')}}" alt="">
               </div>
            </li>
            <li>
               <div class="organizations_box">
                  <img src="{{asset(config('custom.assets').'/images/organizations-img5.jpg')}}" alt="">
               </div>
            </li>
         </ul>
      </div>
