...
@slot('title')
{{ $page_title ?? 'Visa Assistance'}}
@endslot    

@slot('meta_description')
{{ $meta_description ?? 'Visa Assistance'}}
@endslot

@slot('meta_keyword')
{{$meta_keyword ?? 'Visa Assistance'}} 
@endslot
...
<section class="flight_page pb_20">
   <div class="container">
      <div class="text-center">
         <div class="theme-title">
            <div class="title text-3xl pb-5">Visa Assistance</div>
