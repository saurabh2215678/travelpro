        ...
        <span class="glyphicon glyphicon-calendar"></span>
          ...
          <form action="{{route('packageListing')}}" method="GET" name="searchForm" class="" id="search_packages_form" onSubmit="return validateSearchPackageForm()">
            ...
            <div class="flex gap-2 flex-wrap">
              ...
              <div class="selectoption pr-0.5 max-md:w-full">
                <i class="mapicon"></i>
                <input type="text" name="text" class="form-control" value="{{$text}}" id="search_packages" autocomplete="off" placeholder="Search Place/Package">
              ...
              <div class="selectoption pr-0.5 max-md:w-full">
                ...
                <select name="sno_of_days" class=" pl-9">
              ...
              <div class="selectoption pr-0.5 max-md:w-full">
                <i class="calendericon"></i>
                <select name="smonth" class="pl-11">
