<?php if(isset($teams) && !$teams->isEmpty() && $teams->count() > 0){ ?>
...
<div class="xl:container xl:mx-auto">
  ...
  <div class="slider_btns">
        <div class="client-prev theme-prev"><img src="{{ asset(config('custom.assets').'/images/next.png') }}" alt="Next Icon"></div>
        <div class="client-next theme-next"><img src="{{ asset(config('custom.assets').'/images/prev.png') }}" alt="Prev Icon"></div>
     </div>
     </div>
</div>
</div>
