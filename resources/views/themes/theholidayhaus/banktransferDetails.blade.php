...
<section class="payment-section">
	<div class="container">
		<div class="paymen-detail">
			<div class="row">
				<h1 style="width: 100%; text-align: center; background: #003399;font-size: 1.5rem;font-weight: 600;color:#fff;">
				...
				<div class="payment_box">
					<table class="table table-bordered">
						...
						<?php  if($bankData['pay_type'] == 'partial_amount'){ ?>
							<tr>
						...
						<?php /*<tr>
							...
							<tr>
								<td colspan="2" style="padding-top: 15px;">
									...
									<?php } ?>
									<?php if($bankDetails){ ?>
									<p style="font-size: 20px;background: #ffc1074d;padding: 10px;">
