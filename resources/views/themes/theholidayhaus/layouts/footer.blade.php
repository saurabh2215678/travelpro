...
<?php
$websiteSetting = CustomHelper::getSettings(['FACEBOOK','TWITTER','INSTAGRAM','LINKEDIN','YOUTUBE','HTML_VALIDATION','FRONTEND_LOGO','SITE_ADDRESS','SITE_EMAIL','SITE_PHONE','SITE_PHONE1','SITE_PHONE2','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY']);
...
<div class="footer_bottom" id="ftr_btm">
<div class="theme_footer">
    ...
    <div class="container">
        <div class="footer_bottom_inner pb-6 pt-5">
           <div class="footer_bottom_left w-1/4">
             <div class="footer_logo w-36"><a href="{{url('/')}}"><img src="{{ $logoSrc }}" /></a></div>
             <img class="footer-logo2 pt-3" src="{{ asset(config('custom.assets').'/images/footer-logo2.png') }}" />
             <div class="contact_list mt-5">
              <ul>
                <li>{!! $address !!}</li>
                <li>{!! $phone1 !!}</li>
                <li>{!! $email !!}</li>
             ...
             <div class="footer-social">
                <ul class="social_icon my-3">
                  <!-- <li><p class="text-sm">Follow Us: </p></li> -->
                <?php if($facebook){ ?>
                  <li class="facebook"><a href="{{ $facebook }}" target="_blank" ><i class="fa-brands fa-facebook"></i></a></li>
                <?php } ?>
                <?php if($twitter){ ?>
                  <li class="twitter"><a href="{{ $twitter }}" target="_blank"><i class="fa-brands fa-twitter"></i></a></li>
                <?php } ?>
                <?php if($instagram){ ?>
                  <li class="instagram"><a href="{{ $instagram }}" target="_blank"><i class="fa-brands fa-instagram"></i></a></li>
                  <?php } ?>
                  <?php if($linkedin){ ?>
                  <li class="linkedin"><a href="{{$linkedin}}" rel="nofollow" target="_blank" hreflang="en"><i class="fa-brands fa-linkedin"></i></a></li>
                <?php } ?>
              ...
              <div class="copyright text-sm"> Copyright &copy; {{ date('Y') }} {{CustomHelper::WebsiteSettings('SYSTEM_TITLE')}} </a></div>
              <div class="design_by text-sm">Design By : <a href="https://www.indiainternets.com/" target="_blank"> Indiainternets</a> </div>
             </div>
            <div class="footer_bottom_right w-3/4">
              {!! $menuItemsList !!}
            </div>
                ...
                <div class="footer_heading text-lg mb-5">Contact Us</div>
                  <ul class="links_list">
                      <li class="pb-2.5">
                        ...
                        <div class="footer_add flex">
                        <i class="fa-solid fa-location-dot mt-1 mr-2"></i> {!! $address !!}
                        </div> 
                      </li>
                      <li class="pb-2.5">
                        <div class="footer_icon mr-2.5">
                        ...
                        <i class="fa-solid fa-phone mt-1"></i> {!! $phone !!}
                      </li>
                      <li class="phone_footer pb-2.5">
                        <div class="footer_icon mr-2.5">
                          <img src="{{ asset(config('custom.assets').'/img/telephone.png') }}" alt="Telephone">
                        </div>
                        {!! $phone1 !!}
                      ...
                      <li class="pb-2.5">
                        ...
                        <i class="fa-regular fa-envelope mt-1" style="float:left;"></i> {!! $email !!}
                        </div>
                      </li>
...
<!-- <div class="copyright w-full text-sm text-white">
         <div class="container"> 
          <div class="flex">
            <div class="w-1/2"> 
            Copyright &copy; {{ date('Y') }} {{CustomHelper::WebsiteSettings('SYSTEM_TITLE')}}
            </div>  
            <div class="w-1/2 text-right">Design By: <a href="https://www.indiainternets.com/" rel="nofollow" target="_blank">Indiainternets</a></div>  
          </div>
          </div>
    </div> -->
