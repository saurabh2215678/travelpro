		...
		<tbody>
			...
			<tr>
				...
				<ul style="padding: 0 22px;margin-top: 0px;font-family: 'Roboto', sans-serif, Arial;font-size: 12px;line-height: 1.2;">
					...
					<li>You need to collect receipts from the driver for any extra charges paid directly to the driver during the trip. Andaman Island is not liable to provide invoices for such amounts.</li>
					<li>Any grievances or claims related to the cab travel should be reported to Andaman Island within 12 hours of travel time</li>
					...
					<li>You are solely responsible for managing your own travel schedule. Andaman Island will not be liable for any compensation if you happen to miss your scheduled flight, train or bus due to delay pickup, traffic jam or delay due to any other reason during the trip</li>
				</ul>
				</td>
			</tr>
