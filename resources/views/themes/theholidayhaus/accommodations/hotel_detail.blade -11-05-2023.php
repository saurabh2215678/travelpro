...
<section class="pt-0 pb-0">
   <div class="xl:container xl:mx-auto">
      <div class="detail_title mb-5">
         <h1 class="title text-2xl font-bold hotel_name">
         ...
         <div class="left_side  lg:w-8/12 pr-5">
            <div class="left_side_inner">
               ...
               <div class="right_side">
                  ...
                  <form id="myForm" style="padding: 100px;">
                    <input type="text" name="trip_date" id="trip_date" value="10/05/2023">
                    <input type="text" name="inventory" value="200">
                    <input type="hidden" name="hotel" value="{{$accommodation->id}}">
                    <input type="hidden" name="action" value="hotel_booking">
                    <input type="submit" name="submit" value="Book">
                    <span id="trip_date_error"></span>
                  </form>
               </div>
               ...
               <?php } } ?>
               <div class="flex-wrap flex mt-5 mb-3 w-full">
