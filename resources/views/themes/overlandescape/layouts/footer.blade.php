...
<div class="footer_bottom" >
    <div class="xl:container xl:mx-auto">
        <div class="footer_bottom_inner pb-6">
            ...
            <div class="footer_brand py-3">
              <ul>
                <li><img src="{{ asset(config('custom.assets').'/img/brand_left.png') }}"> </li>
                <li><img src="{{ asset(config('custom.assets').'/img/members2.jpg') }}" alt="Members" class="img-responsive w-32"> <img src="{{ asset(config('custom.assets').'/img/members.png') }}" alt="Members" class="img-responsive w-32"></li>
              </ul>
            </div>
        </div>
</div>
