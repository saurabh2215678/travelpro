...
<body> 
	...
	<table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;border: 1px solid #dee2e6;" width="100%">
		<tbody>
			...
			@if(isset($booking_details['adult']) || isset($booking_details['children']) || isset($booking_details['selected_addons']))
			<tr style="background: #ebebeb;">
				<td class="align-top" style="padding: 2px 15px 2px 15px;vertical-align: top;border: 1px solid #585858;">
				<p style="color: #12968e;font-size: 16px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 4px 0px;"><strong>Total Pax</strong></p>
				</td>
				<td class="align-top" style="padding: 2px 15px 2px 15px;vertical-align: top;border: 1px solid #585858;" colspan="2">
				<p style="color: #12968e;font-size: 16px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 4px 0px;"><strong>Add Ons</strong></p>
				</td>
			</tr>
			<tr>
				<td class="align-top" style="padding: 2px 15px 2px 15px;vertical-align: top;border: 1px solid #585858;">
					<p style="color: #333;font-size: 13px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 4px 0px;">
					@if(isset($booking_details['adult']))
						{{$booking_details['adult']??''}} Adults
					@endif
					@if(isset($booking_details['children']))
						, {{$booking_details['children']??''}} Child
					@endif
					</p>
				</td>
				<td class="align-top" style="padding: 2px 15px 2px 15px;vertical-align: top;border: 1px solid #585858;" colspan="2">
					...
					@foreach($booking_details['selected_addons'] as $addon)
						<p style="color: #333;font-size: 13px;font-weight: 400;font-family: 'Roboto', sans-serif, Arial;margin: 4px 0px;">{{$addon['name']??''}}: Qty: {{$addon['qty']??''}}@if(isset($addon['days'])), Days: {{$addon['days']}}@endif</p>
					@endforeach
					@endif				
				</td>
			</tr>
