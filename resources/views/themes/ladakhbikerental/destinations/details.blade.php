      ...
      <section class="destination-slider">
         <div class="container">
            ...
            <div class="theme_title mb-6">
               <h1 class="title text-2xl">{{$destination_name}}</h1>
...
<?php if(!$popular_activities->isEmpty()){ ?>
  <section class="destination-slider">
    <div class="container">
      <div class="text_center">
        <div class="theme_title mb-6">
          <div class="title text-2xl">{{$destination_name}} Tour Activity</div>
        </div>
      </div>
...
<?php if(!empty($faq_row) && count($faq_row) > 0){?>
   <div class="secpad inner-page faq faq-cms-block">
      ...
      <div class="theme_title mb-6">
         ...
         <div class="title text-2xl">FAQs About {{$destinationDetails->name}}</div>
      </div>
        <?php $i = 1; ?>
        <div class="faqlist">
         <ul>
