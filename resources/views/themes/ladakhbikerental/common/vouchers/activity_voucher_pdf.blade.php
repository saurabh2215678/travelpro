				...
				<tr>
					<td colspan="2" style="padding: 2px 15px 2px 15px;background: #e9e9e9;">
						...
						<ul style="padding: 0 22px;margin-top: 5px;font-family: 'Roboto', sans-serif, Arial;/* font-size: 14px; */">
							...
							<li>Andaman Island will not be held responsible for any cancellation or delay of service in case of any natural calamity, agitation or strike, traffic jam or road blockage, etc.</li>
							<li>Any modifications/amendments to the booking are not allowed</li>
							<li>In the event of cancellation of a cab trip, Andaman Island liability will be limited only to the extent of refunding the sum paid by the passenger for the price of the e-ticket</li>
						</ul>
					</td>
				</tr>
				{contact_details}
