<?php
	...
	$popupText = "Hi,\nHow can I help you ?";
	$name = 'Balaji Travels';
	$message = "Hi, I have a query.%0ARef:". $currentURL;
	$logoUrl = '../../images/logo.png';
	$mobileNo = '919936100221';
?>
		...
		<div class="df-btn-content">
			<div class="df-content-topbar">
				<div class="df-brand-img">
					<img src="<?php echo $logoUrl; ?>" height="100%" width="100%" style="border-radius: 50%;" alt="img">
				</div>
				<div style="flex-grow: 1;">
					<div class="df-brand-name"><?php echo $name; ?></div>
		...
		<g>
			...
			<div class="df-content-window">
				<div class="df-window-msg-cont">
					<div class="df-window-msg-cont-brandname"><?php echo $name; ?></div>
					
					<pre class="df-window-msg"><?php echo $popupText; ?></pre>
				</div>
			</div>
...
<script>
var popupTime = <?php echo $popupTime; ?>;
