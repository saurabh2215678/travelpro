...
<?php if(!($blogs->isEmpty())){ 
   ...
   <section class="inner_banner">
      <div class="inner_banner_main">
         <img src="{{asset(config('custom.assets').'/images/what-s-new.jpg')}}" alt="What's & New" >
      </div>
   </section>
      ...
      <div class="container">
         <div class="text-center">
            <div class="theme-title">
               <h1 class="title text-3xl pb-5">What's & New</h1>
            </div>
         </div>
                    ...
                    <div class="swiper-slide">
                     <div class="latest_blog h-full">
                        <div class="latest_blog_images w-1/3 float-left h-full" data-swiper-parallax="-300">
                           <img src="{{ $blogthumbSrc }}" class="img_responsive theme_radius" alt="{{ $blog_title }}" />
                        </div>
         ...
         <div class="slider_btns">
            <div class="cat-next theme-next"><img src="{{asset(config('custom.assets').'/images/next-sm.png')}}" alt="Next Icon"></div>
            <div class="cat-prev theme-prev"><img src="{{asset(config('custom.assets').'/images/prev-sm.png')}}" alt="Prev Icon"></div>
         </div>
      </div>
