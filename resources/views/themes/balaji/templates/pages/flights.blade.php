...
<section class="inner_banner">
  <div class="inner_banner_main">
    <img src="{{ $cmsThumbSrc }}" alt="Book Roundtrip Flights Today!" >
  </div>
</section>
...
<h1 class="title text-3xl pb-5">Book Roundtrip Flights Today!</h1>
...
<div class="flight-list">
  <ul>
    <li><img alt="Vistara" src="{{asset(config('custom.assets').'/images/Vistara_Logo.png')}}" /> <span>Vistara</span></li>
    <li><img alt="Indigo" src="{{asset(config('custom.assets').'/images/Indigo-logo.png')}}" /> <span>Indigo</span></li>
    <li><img alt="Air India" src="{{asset(config('custom.assets').'/images/Air-India-logo.png')}}" /> <span>Air India</span></li>
    <li><img alt="SpiceJet" src="{{asset(config('custom.assets').'/images/SpiceJet-Logo.png')}}" /> <span>SpiceJet</span></li>
    <li><img alt="AirAsia" src="{{asset(config('custom.assets').'/images/AirAsia-Logo.png')}}" /> <span>AirAsia</span></li>
    <li><img alt="GoAir" src="{{asset(config('custom.assets').'/images/GoAir-Logo.png')}}" /> <span>GoAir</span></li>
    <li><img alt="Air India Express" src="{{asset(config('custom.assets').'/images/Air-India-Express-Logo.png')}}" /> <span>Air India Express</span></li>
  </ul>
</div>
