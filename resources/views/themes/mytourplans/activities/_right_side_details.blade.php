...
<form id="myForm">
   ...
   <div class="form_box">
      <div class="city-list-block mb-5">
         <ul>
            <li>
      ...
      <div class="flex items-center flex-wrap justify_btwn">
         <div class="right_price_box">
            ...
            <ul class="form_list w-full float-left flex flex-wrap justify-between">
               ...
               ?>
               <?php if($package_tour_type != 'open' && Customhelper::isOnlineBooking('activity_listing')){ ?>
               <li class="full_field">
                  <!-- <label>{{($select_departure_date==1)?'Departure date':'Select Trip Date'}}</label> -->
                  @if($select_departure_date==1)
                     <div class="form_group icon_calender flex mb-3">
                  @endif
                     ...
                     <div class="single_btn">
                        <ul class="flex flex-wrap justify-between">
                           <?php
                              ...
                              if(isset($priceCategoryElements) && !empty($priceCategoryElements)) {
         ...
         <div class="booknow_btn ">
            ...
            <ul class="btn_group listing_btn">
               ...
               <li>
                  ...
                  @if($package_tour_type != 'open' && Customhelper::isOnlineBooking('activity_listing') && ($show_total_price || !empty($bookingPrice)) && (!empty($full_calender_data_ar))) <input type="submit" class="btn w-full" name="submit" value="Book Online"> @endif
               </li>
               <?php } ?>
               ...
               <div class="swiper-wrapper">
                 ...
                 <div class="swiper-slide">
                  ...
                  <a href="{{asset('/storage/'.$package_path.$image->name)}}" data-fancybox="package_banner">
                     <img src="{{asset('/storage/'.$package_path.$image->name)}}" alt="{{$image->title??''}}" />
                  </a>
                  @else
                  <a href="{{$gThumbImgSrc}}" data-fancybox="package_banner">
                     <img src="{{$gThumbImgSrc}}" alt="{{$image->title??''}}" />
                  </a>
                  @endif                            
                 </div>
                 @endforeach 
