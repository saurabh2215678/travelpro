<?php
$websiteSetting = CustomHelper::getSettings(['FACEBOOK','TWITTER','INSTAGRAM','LINKEDIN','YOUTUBE','HTML_VALIDATION','FRONTEND_LOGO','SITE_ADDRESS','SITE_EMAIL','SITE_PHONE','SITE_PHONE1','SITE_PHONE2','RECAPTCHA_SITE_KEY','RECAPTCHA_SECRET_KEY','WHATSAPP1']);
...
$whatsapp = $websiteSetting['WHATSAPP1']??'';
        ...
        <div class="newslateer_inner">
            ...
            <div class="newsletter_right">
                <div class="newsletter_input">
                    ...
                    <button class="subscribeBtn"><img src="{{ asset(config('custom.assets').'/img/submit.png') }}" alt="Newsletter"></button>
                    </div>
    ...
    <div class="xl:container xl:mx-auto">
        <div class="footer_bottom_inner pb-6">
            ...
            <div class="footer_bottom_right">
                <div class="footer_heading text-lg mb-5">Our Tours</div>
                  <ul class="links_list">
                    
                      <li class="pb-2.5"><a href="{{url('#')}}" class="text-sm">Careers</a></li>
                      <li class="pb-2.5"><a href="{{url('#')}}" class="text-sm">Chat with us</a></li>
                      <li class="pb-2.5"><a href="{{url('privacy-policy')}}" class="text-sm">Privacy Policy</a></li>
                      <li class="pb-2.5"><a href="{{url('terms-conditions')}}" class="text-sm">Terms & Conditions</a></li>
                      <!--<li><a href="{{url('downloads')}}">Downloads</a></li>
                      <li><a href="{{url('others')}}">Others</a></li>
                      <li><a href="{{url('customer-review')}}">Feedback</a></li>-->
            ...
            <div class="footer_bottom_left">
                <div class="footer_heading text-lg mb-5">About</div>
                  <ul class="links_list">
                    
                      <li class="pb-2.5"><a href="{{url('about')}}" class="text-sm">About us</a></li>
                      <li class="pb-2.5"><a href="{{url('privacy-policy')}}" class="text-sm">Privacy Policy</a></li>
                      <li class="pb-2.5"><a href="{{route('testimonialListing')}}" class="text-sm">Testimonials</a></li>
                      <li class="pb-2.5"><a href="{{url('terms-conditions')}}" class="text-sm">Terms & Conditions</a></li>
                      <li class="pb-2.5"><a href="{{url('contact-us')}}" class="text-sm">Contact us</a></li>
                      <!--<li><a href="{{url('downloads')}}">Downloads</a></li>
                      <li><a href="{{url('others')}}">Others</a></li>
                      <li><a href="{{url('customer-review')}}">Feedback</a></li>-->
              ...
              <div class="footer_bottom_right">
                <div class="footer_heading text-lg mb-5">Contact Us</div>
                  <ul class="links_list">
                      ...
                      <!-- <li class="pb-2.5">
                        <div class="footer_icon mr-2.5">
                          <img src="{{ asset(config('custom.assets').'/img/telephone.png') }}">
                        </div>
                        {!! $phone !!}
                      </li>
                      <li class="pb-2.5">
...
<div class="footer_brand">
  <div class="container">
    <ul>
      <li><div class="copyright">  Copyright &copy; {{ date('Y') }} My Tour Plan </a></div></li>
      <li><div class="design_by">Design By : <a href="https://indiainternets.com/"> Indiainternets</a> </div></li>
    </ul>
  </div>
</div>
<a href="https://api.whatsapp.com/send?phone={{$whatsapp}}" class="whatsapp-box" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true"></i></a>
<a href="tel:{{ $whatsapp }}" class="whatsapp-box" target="_blank" style="bottom: 80px;background: blue;"><i class="fa fa-phone" aria-hidden="true"></i></a>
