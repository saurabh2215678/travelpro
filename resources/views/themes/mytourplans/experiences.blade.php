...
@endslot
  ...
  // prd($popular_packages);
      ...
      //prd($btDestination);
      $destination_images = isset($destinationDetails->destinationImages) && !empty($destinationDetails->destinationImages) ? $destinationDetails->destinationImages : "";
  ...
  if(!empty($images) && count($images) > 0){
                  ...
                  <div class="form_group">
                     ...
                     <select class="form_control" name="destination" id="destination">
                        ...
                        <?php if(isset($destinations) && !empty($destinations)){
                           ...
                           if(isset($parent_destinations) && !empty($parent_destinations)){
                        ?>
   ...
   <section>
      <div class="container">
         ...
         <?php if(isset($popular_packages) && !empty($popular_packages)){ ?>
