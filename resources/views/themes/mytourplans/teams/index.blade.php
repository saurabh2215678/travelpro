...
<section class="inner_banner">
   <div class="inner_banner_main">
      <img src="{{asset(config('custom.assets').'/images/Our-Team.jpg') }}" alt="" >
   </div>
</section>
...
<div class="xl:container xl:mx-auto">
      ...
      <div class="flex flex-wrap justify-between mb-5">
         <div>
            ...
            <div class="title text-center text-3xl pb-5">{{$page_title}}</div>
            @endif
            <div class="">
...
<?php if(isset($teamManagers) && !empty($teamManagers)){ ?>
<section class="management_team">
   <div class="container">
      <div class="text_center">
         <div class="theme_title">
...
<?php } ?>
<?php if(isset($teamGuides) && !empty($teamGuides)){ ?>
