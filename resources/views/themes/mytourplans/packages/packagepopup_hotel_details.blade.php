<?php 
//prd($accommodations);
if(isset($accommodations) && !empty($accommodations)){
$accoRating = 0;
$storage = Storage::disk('public');
$accommodation_path = 'accommodations/';
$destination_id = (!empty($accommodations->accommodationDestination))? $accommodations->accommodationDestination->name : "";
$accommodation_facility = (isset($accommodations->accommodation_facility))?json_decode($accommodations->accommodation_facility):[];
$accommodation_name = isset($accommodations->name) ? $accommodations->name:'';
$accommodation_brief = isset($accommodations->brief) ? $accommodations->brief:'';
$accommodation_description = isset($accommodations->description) ? $accommodations->description:'';
$accommodation_star = isset($accommodations->star_classification) ? $accommodations->star_classification:'';
$accommodation_slug = isset($accommodations->slug) ? $accommodations->slug:'';
$accommodation_image = isset($accommodations->image) ? $accommodations->image:'';
...
$accoRating = isset($accommodations->star_classification) ? $accommodations->star_classification:'';
$address = isset($accommodations->address) ? $accommodations->address:'';
    $i = 1;
