        ...
        <div style="clear: both;"></div>
               ...
               <?php $counter=0;foreach($accommodation_arr as $key => $accommodation){$counter++;
                  ...
                  if($accommodation){
                     ...
                     ?>
                     <div style="width: 231px;height:300px;float:left;margin-right:5px;">
                                 <div style="width:231px;height: 200px;overflow: hidden;">
                                    <img src="{{ $accommodationThumbSrc }}" alt="{{$accommodation->name ?? '' }}" width="100%" >
                                 </div>
                                 <div style="width:231px;height: 85px;">
                                    <span style="font-size:15px;font-weight: bold; font-family: Arial, sans-serif;padding: 15px 0px 5px 0px;"> {{$accommodation->name ?? '' }}</span>
                                    <ul style="margin:0;padding-top: 5px;width: 100%">
                                    <?php 
                                    if($accommodation_star) {

                                    for ($i=0; $i < $accommodation_star; $i++) { ?>
                                 ...
                                 <div style="padding-top:5px;">
                                  <img class="map-i" src="{{public_path(config('custom.assets').'/images/map.png')}}" style="height: 15px;" >
                                    <?php
                                    $name_arr = [];
