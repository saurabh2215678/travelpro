    ...
    @endslot
      ...
      <section class="inner_banner">
         <div class="inner_banner_main">
            <img src="{{asset(config('custom.assets').'/img/default_banner.jpg')}}" alt="" >
         </div>
         <div class="hidden">
      ...
      <section class="recommendation_place pack-category">
           ...
           <div class="mb50">
            <div class="theme-title">
              <div class="flex flex-wrap justify-between">
                ...
                <div class="title text-3xl pb-5">{{$page_title}}</div>
                @endif
        ...
        <a class="tour_category_box m-0" href="{{ route('tourCategoryDetail',[$theme->slug]) }}">
              <div class="images"><img src="{{ $themeSrc }}"  class="theme_radius"/></div>
            </a>
