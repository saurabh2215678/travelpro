         ...
         <div class="container">
            <div>
               <div class="theme_title mb-6">
                  <div>
                     ...
                     <div class="title text-2xl mb-5">{{$page_title}}</div>
                     @endif
                     <div>
           ...
           <div class="client_review_box lg:w-1/4">
             ...
             <a href="{{ route('testimonialDetails',['slug'=>$tSlug]) }}" class="team_management_box">
                     <div class="images"><img src="{{ $testimonialSrc }}" class="theme_radius img_responsive" alt=""></div>
                     <div class="client_info px-5">
                        <div class="name para_lg2 text-center">{{ $tName }}</div>
