...
?>
   ...
   <section class="search_home py-0 md:px-0 hidden" data-aos="fade-up">
      <div>
...
<section class="team_single_wrap testimonials-details" >
   <div class="container">
   <div class="title text-2xl mb-5">What Our Customers Say {{ $testimonial_title }}</div>
         ...
         <div class="team_single_box leftsec">
            ...
            <div class="right_box my-3" data-aos="fade-right" data-aos-duration="3000">
               <div class="team_info_single pt-3">
                  ...
                  <div class="designation para_lg1 pb-3 theme-color"><img class="object-cover" src="{{ $testimonialThumbSrc }}"> {{ $testimonial_name }}</div>
               </div>
