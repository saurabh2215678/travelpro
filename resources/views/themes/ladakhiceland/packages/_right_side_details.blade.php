...
<form id="myForm">
            ...
            <ul class="form_list w-full float-left flex flex-wrap justify-between">
               ...
               <li>
                  <?php if($packagePrices && count($packagePrices) > 0){ ?>
                     <div class="package_type flex justify-between items-center">
                        ...
                        <ul class="flex flex-wrap  ">
                           ...
                           <li class="traveller_pricing_inner">
                              <div class="form_group">
                                 ...
                                 <div style="color:#0087ce;font-size:13px;" class="price_select{{$element->id}}">₹0</div>
                              </div>
                           </li>
                           <?php
                              }
   ...
   <div class="left_side my-5 icon-wishlist relative flex justify-between flex-wrap">
      @if($package_inclusions)
      ...
      <ul class="inclusions inclusions_list">
         ...
         <li data-text="<?php echo $inclusion_val;?>">
            ...
            <img  src="{{$i_image}}" style="width: 50px; max-width: 3.313rem; height: 3rem; object-fit: contain; padding: 0.5rem;"/>
