...
$whatsapp1 = $websiteSetting['WHATSAPP1']??'';
    ...
    <div class="xl:container xl:mx-auto">
        <div class="footer_bottom_inner pb-6">
            ...
            <div class="footer_bottom_left">
              <div>
                <a href="/"> <img src="../assets/ladakhiceland/images/footer-logo.png" alt="" class="footer_logo"></a>
                  <ul class="links_list">
                      <li class="pb-2.5">
            ...
            <div class="footer_bottom_left">
              ...
              <div class="footer_bottom_right">
                <div class="newsletter_left">
                  <div class="text_lg heading2">Subscribe</div>
                </div>
...
<div class="footer_brand">
  <div class="container">
    <ul>
      <li><div class="copyright">  Copyright &copy; {{ date('Y') }} Ladakh Iceland </a></div></li>
