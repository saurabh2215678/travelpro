                ...
                <br>
                    <form method="GET" action="{{ $action_url }}" accept-charset="UTF-8" role="form" class="form-inline heightform" enctype="multipart/form-data">
                        <div class="col-md-3 form-group {{ $errors->has('name') ? ' has-error' : '' }} ">
                            <label for="name" class="control-label required"><b>Name:</b></label>
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn_admin btn btn-success btn1search"><i class="fa fa-search"></i> Search</button>
                        </div>
                        <?php
                        if($name || $status){
                            ?>
                            <a href="{{ url('admin/payment-gateways') }}" class="btn resetbtn btn-primary btn1search" title="Reset">Reset</a>
                            <?php
                        }
                        ?>
                    </form>
