           ...
           {{ csrf_field() }}
            <div class="form-title row">
               ...
               <div class="col-sm-6 font-weight-bold">
                <?php if($order_id){?>
                  <a style="float:right;margin-top: 10px;" href="<?php echo route('admin.voucher.package_voucher_view', [$order_id,'order'=>$payment_status]) ?>" class="btn btn-primary">PDF View</a>
               <?php } ?>
               </div>
            </div>
            <div class="form-group row">
               <label for="input" class="col-sm-2 col-form-label required">Name of the Pax</label>
               <div class="col-sm-10">
                  <input type="text" name="name_of_pax" value="{{ old('name_of_pax',$name_of_pax) }}" class="form-control" >
               </div>
            </div>
            <div class="form-group row">
               <label for="input" class="col-sm-2 col-form-label required">Pax Contact</label>
               <div class="col-sm-10">
                  <input type="text" name="pax_contact" value="{{ old('pax_contact',$pax_contact) }}" class="form-control" placeholder="">
               </div>
            </div>
            <div class="form-group row">
               <label for="input" class="col-sm-2 col-form-label required">Local Contact</label>
               <div class="col-sm-10">
                  <input type="number" name="local_contact" value="{{ old('local_contact',$local_contact) }}" class="form-control" placeholder="">
               </div>
            </div>
            <div class="form-group row">
               <label for="input" class="col-sm-2 col-form-label required">Agent Contact</label>
               <div class="col-sm-10">
...
// ============ hotel_fields =========
   ...
   divtest.innerHTML = '<div class="col-sm-2 nopadding location_wrapper"><div class="form-group">'+ holtelSelect +'</div></div><div class="col-sm-2 nopadding hotel_wrapper"><div class="form-group">'+ holtelRefSelect +'</div></div><div class="col-sm-2 nopadding"><div class="form-group"> <input type="date" class="form-control" id="Date" name="date[]"  placeholder="Date"></div></div><div class="col-sm-2 nopadding"><div class="form-group"><div class="input-group"> <select class="form-control" id="nightsDate" name="night[]"><option >Select</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option> <option value="5">5</option><option value="6">6</option><option value="7">7</option></select><div class="input-group-btn"> </div></div></div></div> <div class="col-sm-2 nopadding"><div class="form-group"><div class="input-group"> <select class="form-control" id="rooms" name="rooms[]"><option >Select</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option> <option value="5">5</option><option value="6">6</option> <option value="7">7</option> </select></div></div></div><div class="col-sm-2 nopadding"><div class="form-group"> <input type="text" class="form-control" id="Mealsname" name="meals[]"  placeholder="Meals"> <button class="btn btn-danger" type="button" onclick="remove_hotel_fields('+ room +');"> <span class="glyphicon glyphicon-minus" aria-hidden="true"></span> </button></div></div><div class="clear"></div>';
