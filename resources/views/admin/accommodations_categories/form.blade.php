...
if(empty($back_url)){
    $back_url = $routeName.'/accommodations_categories';
}

    //pr($blog->toArray());
$routeName = CustomHelper::getAdminRouteName();

$id = (isset($category_query->id))?$category_query->id:'';
...
?>
   ...
   <div class="top_title_admin"> 
    ...
    <div class="add_button">
        ...
        <a href="{{ url('admin/accommodations/category')}}" class="btn_admin" ><i class="fa fa-long-arrow-left" aria-hidden="true"></i>
           Back</a><?php } ?>
       </div>
   </div>
   <div class="centersec">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success" title="Create this new accommodation category"><i class="fa fa-save"></i> Submit</button>
                </div>
            </div>
        </div>
    </div>
