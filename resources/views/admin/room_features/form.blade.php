...
if(empty($back_url)){
    $back_url = $routeName.'/room_features';
}
...
?>
   ...
   <div class="top_title_admin">
    ...
    <div class="add_button">
        ...
        <a href="{{ url('admin/accommodations/room_feature')}}" class="btn_admin"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>
           Back</a><?php } ?>
       </div>
   </div>
   <div class="centersec">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-success" title="Create this new room features"><i class="fa fa-save"></i> Submit</button>
                </div>
            </div>
        </div>
    </div>
