...
<?php
$active_menu = "testimonials".$id.'/seo_meta';
?>
        ...
        <div class="bgcolor">
            ...
            <form method="POST" action="" accept-charset="UTF-8" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-12{{ $errors->has('meta_keywords') ? ' has-error' : '' }}">
                    <label for="meta_keywords" class="control-label" maxlength="688" >Meta Keyword:</label>

                    <input type="text" name="meta_keywords" value="{{ old('meta_keywords', $meta_keywords)}}" id="meta_keywords" class="form-control"  />    
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <a href="{{ route($routeName.'.testimonials.seo_view',['id'=>$id]) }}" class="btn_admin2" title="Cancel">Cancel</a>
                    </div>
                </div>
            </form>
