...
$id = (isset($roomView->id))?$roomView->id:'';
...
?>
    ...
    <div class="top_title_admin">
        ...
        <div class="add_button">
            ...
            <a href="{{url('admin/accommodations/room_master/'.$slug)}}" class="btn_admin"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>
               Back</a><?php } ?>
           </div>
       </div>
       <div class="centersec">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                        <label for="name" class="control-label required">Title:</label>

                        <input type="text" id="name" class="form-control" name="name" value="{{ old('name', $title) }}" />
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success" title="Create this new room View"><i class="fa fa-save"></i> Submit</button>
                        <a href="{{url('admin/accommodations/room_master/'.$slug)}}" class="btn_admin2">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
