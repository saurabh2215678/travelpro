    ...
    <div class="centersec">
        <div class="top_title_admin tab-title">
            ...
            <div class="add_button">
              ...
              <a href="{{ route($routeName.'.cab_master.add').'?back_url='.$back_url }}" class="btn_admin"><i class="fa fa-plus"></i>Add Cab</a>
              @endif
          </div>
      </div>
      <style>
                ...
                <form class="form-inline" method="GET">
                   ...
                   <div class="col-md-6">
                    <label></label><br>
                        ...
                        <a href="{{route($routeName.'.cab_master.index')}}" class="btn_admin2">Reset</a>
                    </div>
                </form>
            </div>
        </div>
                        ...
                        <tbody class="row_position">
                         ...
                         <tr class="ui-sortable-handle" id="{{$cab->id}}">
                            ...
                            <td>
                                ...
                                <a href="{{ route($routeName.'.cab_master.edit', $cab->id.'?back_url='.$back_url) }}" title="Edit Cab"><i class="fas fa-edit"></i></a>
                                @endif
                                ...
                                <a href="javascript:void(0)" class="sbmtDelForm"  id="{{$cab->id}}" title="Delete Cab"><i class="fas fa-trash-alt"></i></i></a>
                                 ...
                                 <form method="POST" action="{{ route($routeName.'.cab_master.delete', $cab->id) }}" accept-charset="UTF-8" role="form" onsubmit="return confirm('Are you sure you want to remove this cab?');" id="delete-form-{{$cab->id}}">
                                    {{ csrf_field() }}
                                    {{ method_field('POST') }}
...
<script>  
    function updateCab(data) {  
        ...
        $.ajax({  
            url : "{{ route('admin.cab_master.update_cab') }}",
            type : 'POST',  
            data:{data:data},
            dataType:"JSON",
