...
@slot('title')
Admin - Accommodation Room Type Details - {{CustomHelper::WebsiteSettings('SYSTEM_TITLE')}}
@endslot
    ...
    <td width="806" valign="top" class="innersec">
        <table cellspacing="1" class="table table-bordered" cellpadding="0" border="0" width="100%">
              ...
              <tr>
                <td>
                    <div><b>Title: </b></div>
                    <div> {{$roomTyp->title}}</div>
                </td>
                <td>
                    <div><b>Status: </b></div>
                    <div>{{CustomHelper::getStatusStr($roomTyp->status)}}</div>
                </td>
                <td>
                    <div><b>Sort Order: </b></div>
                    <div>{{$roomTyp->sort_order}}</div>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    ...
                    <div>{{CustomHelper::DateFormat($roomTyp->created_at, 'd/m/Y')}}</div>
                </td>
            </tr>
</table>
</div>
