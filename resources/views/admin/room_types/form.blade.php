...
if(empty($back_url)){
    $back_url = $routeName.'/room_types';
}

    //pr($blog->toArray());
// $routeName = CustomHelper::getAdminRouteName();

$id = (isset($roomTyp->id))?$roomTyp->id:'';
$title = (isset($roomTyp->title))?$roomTyp->title:'';
$status = (isset($roomTyp->status))?$roomTyp->status:1; 
$sort_order = (isset($roomTyp->sort_order))?$roomTyp->sort_order:0;
...
?>
    ...
    <div class="top_title_admin">
        ...
        <div class="add_button">
            ...
            <a href="{{ url('admin/accommodations/room_type')}}" class="btn_admin"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>
               Back</a><?php } ?>
           </div>
       </div>
       <div class="centersec">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success" title="Create this new room types"><i class="fa fa-save"></i> Submit</button>
                    </div>
                </div>
            </div>
        </div>
