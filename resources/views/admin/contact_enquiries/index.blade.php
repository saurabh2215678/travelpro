    ...
    <div class="title">
    <h2>Enquiries ({{ $enquiries->total() }})</h2>
    </div>
                ...
                <table class="table table-bordered">
                    ...
                    foreach ($enquiries as $enquiry){ ?>
                        <tr>
                            <td>{{$enquiry->name}}</td>
                            <td>
                                <p><strong>Email: </strong>{{ $enquiry->contact_email }}</p>
                                <p><strong>Phone: </strong>{{ $enquiry->phone }}</p>
                                <p><strong>Country: </strong>{{ $enquiry->country }}</p>
                                <p><strong>Message: </strong>{{ CustomHelper::wordsLimit($enquiry->comment,100,true) }}</p>
