									...
									<tbody>
										<tr style="background-color: #fff6ec;">
											<td align="left" style="padding: 20px 40px; border-bottom: 1px solid #00000017;" colspan="2">
												...
												<div style="font-size: 18px; text-align: right; float: right; margin-top: 5px; color: #952a25; font-weight: 500;">
													Payment Details<br>Date - <?php date_default_timezone_set("Asia/Thimphu"); 
										...
										<tr>
											<td style="padding: 30px 0px 0 40px;" colspan="2">
												...
												<p style="font-size: 16px; font-family: 'Roboto', sans-serif, Arial; color: #51535c; line-height: 32px; margin-bottom: 0; margin-top: 10px;">
													You have a new payment details, Please find the details below:
												</p>
											</td>
										</tr>
										...
										<tr>
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>Transaction Id : </strong> {{ $txn_id }}</p>
											</td>
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>Sub Total Amount : </strong> {{CustomHelper::getPrice($sub_total_amount)}}</p>
											</td>
										</tr>
										...
										<tr>
											...
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong> Total Amount : </strong> {{CustomHelper::getPrice($total_amount)}}</p>
											</td>
										</tr>
										...
										<tr>
											...
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong> Payment Status : </strong><?php echo ($status == 1) ? "Completed" : "Pending"; ?>
							                    </p>
											</td>
										</tr>
										...
										<tr>
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>Payer Name: </strong> {{ $name }}</p>
											</td>
											<td style="padding: 10px 0px 10px 40px;">					
										...
										<tr>
											...
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>Paypal ID: </strong> Test</p>
											</td>
										</tr>
									</tbody>
								</table>
