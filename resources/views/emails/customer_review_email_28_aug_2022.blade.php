									...
									<tbody>
										<tr>
											<td style="padding: 20px 0px 20px 40px;">
												<a href="{{url('/')}}"><img src="{{config('custom.assets').'/images/logo.png')}}" alt="logo" width="186" height="31"></a>
											</td>
										</tr>
										<tr bgcolor="#2d3c74">
											<td align="left" style="color: #fff; font-size: 20px; padding: 20px 40px;">Customer Review Us <br>Date - <?php date_default_timezone_set("Asia/Thimphu");
											echo date('d M Y'); ?> at (<?php echo date('H:i A'); ?>) </td>
										...
										<tr>
											<td style="padding: 10px 0px 10px 40px;">					
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>Sightseeing Comments: </strong> {{ $sight_tour_comments }}</p>
											</td>
										</tr>
