        ...
        <tr>
            <td>
                ...
                <table style="text-align: center;">
                    ...
                    <tr><td><h4 style="font-size: 16px; padding: 0 25px ; margin-bottom: 0; text-align: center;">Thanks For Registering GrandIndiaTour your otp to verify you email is :</h4></td></tr>
