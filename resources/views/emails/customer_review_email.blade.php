									...
									<tbody>
										...
										<tr>
											<td style="padding: 30px 0px 0 40px;" colspan="2">
												...
												<p style="font-size: 16px; font-family: 'Roboto', sans-serif, Arial; color: #51535c; line-height: 32px; margin-bottom: 0; margin-top: 10px;">
													You have a new customer review enquiry, details given below:
												</p>
											</td>
										</tr>
										...
										?>
											<td style="padding: 10px 0px 10px 40px;">
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>{{$fd_key}}: </strong> {!!$fd_val!!}</p>
											</td>
										<?php
												if(fmod($ii,2)==0) {
													echo '</tr><tr>';
										...
										<tr>
											<td style="padding: 10px 0px 10px 40px;">
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>Your Name: </strong> {{$name??''}}</p>
											</td>
											<td style="padding: 10px 0px 10px 40px;">
												<p style="color: #3a3a3c; font-size: 17px; font-weight: 400; font-family: Roboto; margin: 4px 0px;"><strong>E-Mail: </strong> {{$email??''}}</p>
											</td>
										</tr>
									</tbody>
								</table>
