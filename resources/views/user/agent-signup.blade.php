...
$bookings_per_month = old('bookings_per_month');
$bookings_per_month = !empty($bookings_per_month) ? $bookings_per_month :'';

$employees = old('no_of_employees');
$employees = !empty($employees) ? $employees :'';

$agency_age = old('agency_durations');
$agency_age = !empty($agency_age) ? $agency_age :'';

$region = old('traveler_regions');
$region = !empty($region) ? $region :'';

$source = old('source_types');
...
<div class="container">
    ...
    <div class="text_center">
        <div class="theme-title">
            <div class="text-2xl">Agent Signup 2</div>
        </div>
    </div>
   @include('snippets.front.flash')
    ...
    <div class="signup_form singup_form_wrap">
        <div class="singup_form_inner">
           ...
           <div class="form_group">
            ...
            <div class="form_group">
             ...
             <div class="form_group">
                <label for="gst_no" class="control-label text-xs">GST Number</label>
            ...
            <div class="form_group">
                <label class="control-label text-xs">Upload GST</label>
            ...
            <div class="form_group">
                <label class="control-label text-xs">Agent Logo</label>
                <input type="file" name="agent_logo" id="agent_logo" value="{{old('agent_logo')}}" class="form_control">
                @include('snippets.front.errors_first', ['param' => 'agent_logo'])
            </div>
          ...
          <?php /*  <div class="form_group">
                <label for="no_of_employees" class="control-label required text-xs">Number of Employees?<em>*</em></label>
           ...
           <?php /* <div class="form_group">
                <label for="agency_age" class="control-label required text-xs">How old is you agency?<em>*</em></label>
           ...
           <div class="form_group">
            ...
            <?php /*   <div class="form_group">
                <label for="region" class="control-label required text-xs">Your current travelers are from which region? (for international user)<em>*</em></label>
           ...
           <?php /* <div class="form_group"  style="width:100%;">
            ...
            <div class="form_group" style="margin-top: 12px;">
                <label for="source" class="control-label required text-xs">Where did you hear about us?</label>
        ...
        <div class="form_group submit_btn">
          ...
          <div class="create_account">Skip as a customer <a href="{{route('user.profile')}}">Click here!</a>
          </div>
    </div>
    {{ Form::close() }}
    </div>
