	...
	<table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto;border: 1px solid #dee2e6;" width="100%">
		<tbody>
			<tr style="background-color: #18afa6;">
				<td align="left" colspan="2" style="padding: 10px 15px;border-bottom: 1px solid #00000017;">
				<div style=""><a href="{{url('/')}}"><img alt="logo" src="{logo}" style="height: 45px;" /></a></div>
				</td>
				<td align="left" style="padding: 10px 15px;border-bottom: 1px solid #00000017;">
				<p style="color: #fff;padding: 0;margin: 0;font-family: 'Roboto', sans-serif, Arial;font-size: 13px;">Booking ID: {order_id}</p>
				<p style="color: #fff;padding: 0;margin: 0;font-family: 'Roboto', sans-serif, Arial;font-size: 13px;">Booked on: {booking_date}</p>
				</td>
			</tr>
			<tr style="">
