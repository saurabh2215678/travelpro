...
class FlightApiController extends Controller {
   ...
   /*public function index(Request $request) {
        $data = [];
        return view('admin.flight_apis.index', $data);
    }*/

    public function index(Request $request){

        $data= [];
        $data['page_heading']= 'Flight APIs Configuration';
        ...
        if($method == 'POST' || $method == 'post'){
                ...
                array_push($new_array,'TRIPJACK_API_KEY','TRIPJACK_API_URL');
                 ...
                 $save_settings = app('App\Http\Controllers\Admin\SettingsController')->save_settings($request,$new_array);
       ...
       return view('admin.flight_apis.form', $data);
